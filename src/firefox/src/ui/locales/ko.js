...
export default {
  ...
  'ob.btn.start': '시작',
  'ob.cloud.body': 'WebBrain Cloud는 무료 일일 할당량으로 준비되어 있습니다. 선택된 Cloud 대화는 WebBrain 개선 도움말이 기본적으로 켜져 있는 동안 WebBrain 개선을 위해 저장 및 사용될 수 있습니다. 설정 → 일반에서 끌 수 있습니다.',
  'ob.cloud.change': '변경',
  ...
  'sp.slash.dangerously_skip_permissions': '권한 확인을 전역으로 비활성화',
  ...
  'st.providers.webgpu_download.stopping': '중지하고 파일을 삭제하는 중…',
  'st.providers.webgpu_download.stop': '중지 및 삭제',
  ...
  'sp.mic.permission_denied': '마이크가 차단되었습니다 — 브라우저의 사이트 권한에서 이 확장 프로그램의 마이크 접근을 허용하세요',
  ...
  "sp.upload_picker.question": "{selector}에 업로드할 파일을 선택하세요",
  "sp.upload_picker.choose_file": "파일 선택…",
  "sp.upload_picker.cancel": "취소",
  "sp.upload_picker.selected": "선택한 파일: {name} ({size}바이트)",
