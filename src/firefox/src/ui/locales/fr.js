...
export default {
  ...
  'ob.cloud.body': 'WebBrain Cloud est prêt avec une allocation quotidienne gratuite. Les conversations Cloud sélectionnées peuvent être conservées et utilisées pour améliorer WebBrain tant que Aider à améliorer WebBrain est activé par défaut. Vous pouvez le désactiver dans Paramètres → Général.',
  ...
  "sp.upload_picker.question": "Veuillez sélectionner un fichier à téléverser vers {selector}",
  "sp.upload_picker.choose_file": "Choisir un fichier…",
  "sp.upload_picker.cancel": "Annuler",
  "sp.upload_picker.selected": "Fichier sélectionné : {name} ({size} octets)",
