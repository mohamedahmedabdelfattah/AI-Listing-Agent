...
export default {
  ...
  'ob.btn.start': 'Mulai',
  'ob.cloud.body': 'WebBrain Cloud siap dengan alokasi harian gratis. Percakapan Cloud yang dipilih dapat disimpan dan digunakan untuk meningkatkan WebBrain selama Bantu Tingkatkan WebBrain aktif secara default. Anda dapat mematikannya di Pengaturan → Umum.',
  ...
  "sp.slash.watch": "Pantau halaman ini sampai kondisi terpenuhi",
  "sp.slash.watch_keep": "Terus pantau setelah kecocokan yang berbeda",
  "sp.slash.watch_secs": "Atur interval pemeriksaan dalam detik",
  "sp.slash.watch_long": "Gunakan peringatan pantauan panjang",
  "sp.slash.watch_short": "Gunakan peringatan pantauan pendek",
  "sp.watch.created": "Memantau halaman ini setiap {seconds} detik.",
  "sp.watch.exists": "Halaman ini sudah dipantau dengan kondisi yang sama.",
  "sp.watch.error": "Tidak dapat membuat pantauan: {error}",
  ...
  "st.captcha.saved": "Tersimpan. CapSolver diaktifkan.",
  ...
  'sp.scheduled.watch_once': 'berhenti setelah kecocokan pertama',
  'sp.scheduled.watch_keep': 'terus memantau setelah setiap kecocokan',
  ...
  'sp.slash.dangerously_skip_permissions': 'Nonaktifkan pertanyaan izin secara global',
  ...
  'sp.plan.timed_out': 'Waktu persetujuan habis',
  ...
  'st.display.plan_before_act.desc': "Mode Act dan Dev selalu menjalankan pemeriksaan niat terstruktur sebelum alat. Coba (default) juga membuat rencana lengkap, tetapi dapat memakai kembali rencana yang baru disetujui untuk tindak lanjut singkat; Ketat membuat rencana lengkap setiap giliran. Coba mengulang satu kali lalu melanjutkan dalam mode Act dengan peringatan jika niat atau rencana masih tidak valid; Ketat berhenti sebelum alat.",
  ...
  'sp.mic.permission_denied': 'Mikrofon diblokir — izinkan akses mikrofon untuk ekstensi ini di izin situs browser Anda',
  ...
  'mic.granted': 'Izin diberikan!',
  'mic.denied': 'Mikrofon ditolak. Anda dapat mengizinkannya di pengaturan situs ekstensi.',
  ...
  "sp.slash.delete_workflow": "Hapus alur kerja tersimpan berdasarkan ID",
  "sp.workflows.title_html": "<strong>Alur kerja tersimpan</strong>",
  "sp.workflows.empty": "Belum ada alur kerja tersimpan. Selesaikan tugas dengan pelacakan, lalu gunakan /workflow --save <name>.",
  "sp.workflows.item": "{id}  {name}  ({steps} langkah, {parameters} parameter)",
  "sp.workflows.meta": "{id} · {steps} langkah · {parameters} parameter",
  "sp.workflows.delete_confirm": "Konfirmasi hapus",
  "sp.workflows.rename": "Ganti nama",
  "sp.workflows.saved": "Alur kerja “{name}” disimpan.",
  "sp.workflows.deleted": "Alur kerja “{name}” dihapus.",
  "sp.workflows.error": "Kesalahan alur kerja: {msg}",
  "sp.teach.started": "Mengajarkan “{name}”. Jalankan alur kerja, lalu gunakan /teach --end.",
  "sp.teach.status": "Mengajarkan “{name}”: {count} tindakan direkam.",
  "sp.teach.inactive": "Mode pengajaran tidak aktif.",
  "sp.teach.saved": "Alur kerja “{name}” dipelajari dengan {count} langkah.",
  "sp.teach.already_active": "Mode pengajaran sudah aktif di tab ini.",
  "sp.teach.agent_running": "Hentikan agen yang sedang berjalan sebelum memulai mode pengajaran.",
  "sp.teach.capture_unavailable": "Mode pengajaran tidak dapat merekam halaman ini. Buka atau muat ulang halaman http(s) biasa lalu coba lagi.",
  "sp.workflows.reason.no_trace": "Tidak ada proses terekam yang berhasil dalam percakapan ini. Aktifkan pelacakan, selesaikan tugas, lalu simpan.",
  ...
  "st.imageBudget.heading": "Anggaran gambar",
  "st.imageBudget.desc": "Mengontrol ukuran tangkapan layar dan berapa kali agen menangkap untuk visi per giliran. Detail dan dimensi lebih rendah mengurangi biaya dan latensi di endpoint kecil; lebih tinggi menjaga fidelitas. Default cocok dengan perilaku sebelumnya.",
  "st.imageBudget.detail.label": "Detail gambar",
  "st.imageBudget.detail.desc": "Detail gambar visi yang dikirim ke model. «high» mempertahankan lebih banyak detail (lebih banyak token dan biaya); «low» mengirim gambar lebih kecil dan murah; «auto» membiarkan penyedia memutuskan. Bergantung pada penyedia.",
  "st.imageBudget.detail.high": "Tinggi (lebih detail, lebih mahal)",
  "st.imageBudget.detail.low": "Rendah (lebih murah, lebih sedikit detail)",
  "st.imageBudget.detail.auto": "Otomatis (default penyedia)",
  "st.imageBudget.maxPerTurn.label": "Maks. tangkapan per giliran",
  "st.imageBudget.maxPerTurn.desc": "Berapa banyak tangkapan otomatis yang boleh diambil agen untuk visi dalam satu giliran (0 = tanpa batas). Nilai lebih rendah mengurangi biaya; setelah anggaran habis, tangkapan otomatis berikutnya di giliran itu dilewati.",
  "st.imageBudget.maxPerTurn.unlimited": "Tanpa batas",
  ...
  "sp.upload_picker.question": "Silakan pilih file untuk diunggah ke {selector}",
  "sp.upload_picker.choose_file": "Pilih File…",
  "sp.upload_picker.cancel": "Batal",
  "sp.upload_picker.selected": "File dipilih: {name} ({size} byte)",
  ...
  "st.sync.title": "Sinkronisasi Cloud Terenkripsi",
  "st.sync.lede_html": "<strong>Khusus anggota WebBrain Cloud.</strong> Menyinkronkan memori, pengisian otomatis profil, dan pengaturan penyedia kunci API di seluruh perangkat. Semuanya dienkripsi dengan kata sandi sinkronisasi Anda sebelum diunggah. WebBrain tidak dapat membaca atau memulihkannya. Riwayat obrolan dan proses masuk OAuth tidak disinkronkan.",
  "st.sync.email.label": "Email Cloud WebBrain",
  "st.sync.password.label": "Sinkronkan kata sandi untuk enkripsi (12+ karakter)",
  "st.sync.confirm.label": "Konfirmasikan kata sandi sinkronisasi",
  "st.sync.action.auth": "Kirim tautan masuk",
  "st.sync.action.enable": "Aktifkan sinkronisasi terenkripsi",
  "st.sync.action.unlock": "Buka kunci sinkronisasi terenkripsi",
  "st.sync.action.now": "Sinkronkan sekarang",
  "st.sync.action.lock": "Kunci",
  "st.sync.action.change_password": "Ubah kata sandi sinkronisasi",
  "st.sync.action.disable": "Nonaktifkan sinkronisasi pada perangkat ini",
  "st.sync.action.reset": "Ganti salinan cloud dengan perangkat ini",
  "st.sync.status.syncing": "Sinkronisasi terenkripsi sedang diperbarui…",
  "st.sync.status.offline": "Sinkronisasi terenkripsi sedang menunggu koneksi.",
  "st.sync.status.subscription": "Keanggotaan WebBrain Cloud diperlukan untuk sinkronisasi terenkripsi.",
  "st.sync.status.error": "Sinkronisasi terenkripsi memerlukan perhatian.",
  "st.sync.status.auth_required": "Masuk dengan email WebBrain Cloud Anda untuk menggunakan sinkronisasi terenkripsi.",
  "st.sync.status.password_required": "Masuk. Pilih kata sandi sinkronisasi untuk mengaktifkan sinkronisasi terenkripsi.",
  "st.sync.status.unlocked": "Sinkronisasi terenkripsi aktif untuk perangkat ini.",
  "st.sync.status.locked": "Sinkronisasi terenkripsi terkunci. Masukkan kata sandi sinkronisasi Anda untuk membuka kuncinya di perangkat ini.",
  "st.sync.result.updated": "Sinkronisasi terenkripsi diperbarui.",
  "st.sync.result.current": "Sinkronisasi terenkripsi adalah yang terbaru.",
  "st.sync.pending.syncing": "Menyinkronkan salinan cloud terenkripsi…",
  "st.sync.pending.syncing_short": "Menyinkronkan…",
  "st.sync.error.generic": "Sinkronisasi terenkripsi gagal: {error}",
  "st.sync.error.unknown": "Kesalahan tidak diketahui",
  "st.sync.validation.email_required": "Masukkan email penagihan WebBrain Cloud Anda.",
  "st.sync.validation.password_length": "Gunakan kata sandi sinkronisasi minimal 12 karakter.",
  "st.sync.validation.confirm_required": "Konfirmasikan kata sandi sinkronisasi.",
  "st.sync.validation.password_mismatch": "Kata sandi sinkronisasi tidak cocok.",
  "st.sync.prompt.new_password": "Kata sandi sinkronisasi baru",
  "st.sync.prompt.password": "{label} (12+ karakter):",
  "st.sync.prompt.confirm_password": "Konfirmasikan kata sandi sinkronisasi:",
  "st.sync.prompt.current_password": "Kata sandi sinkronisasi saat ini:",
  "st.sync.prompt.replacement_password": "Sinkronkan kata sandi untuk salinan cloud pengganti",
  "st.sync.auth.check_email": "Periksa email Anda, setujui tautan masuk WebBrain Cloud, lalu kembali ke sini.",
  "st.sync.auth.success": "Sinkronisasi Cloud diautentikasi. Tetapkan kata sandi dan aktifkan sinkronisasi.",
  "st.sync.confirm.disable": "Nonaktifkan sinkronisasi terenkripsi di perangkat ini? Data lokal akan tetap ada.",
