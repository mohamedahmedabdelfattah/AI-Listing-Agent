...
export default {
  ...
  'sp.slash.dangerously_skip_permissions': '全局禁用权限提示',
  ...
  "sp.mic.permission_denied": "麦克风已被阻止 — 请在浏览器的网站权限中允许此扩展访问麦克风",
  ...
  "sp.upload_picker.question": "请选择要上传到 {selector} 的文件",
  "sp.upload_picker.choose_file": "选择文件…",
  "sp.upload_picker.cancel": "取消",
  "sp.upload_picker.selected": "已选文件：{name}（{size} 字节）",
