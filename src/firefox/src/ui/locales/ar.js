...
export default {
  ...
  'sp.mic.permission_denied': 'الميكروفون محظور — اسمح بالوصول إلى الميكروفون لهذه الإضافة من أذونات المواقع في المتصفح',
  ...
  "sp.upload_picker.question": "يرجى اختيار ملف للرفع إلى {selector}",
  "sp.upload_picker.choose_file": "اختر ملفًا…",
  "sp.upload_picker.cancel": "إلغاء",
  "sp.upload_picker.selected": "الملف المحدد: {name} ({size} بايت)",
