...
export default {
  ...
  'ob.btn.skip': '今はスキップ',
  'ob.btn.start': '開始',
  'ob.cloud.body': 'WebBrain Cloudは1日あたりの無料割り当てで準備できています。選択したCloud会話は、WebBrainの改善支援がデフォルトでオンになっている間、WebBrainの改善のために保存および使用される可能性があります。設定 → 一般でオフにできます。',
  'ob.cloud.change': '変更',
  'ob.cloud.using': 'WebBrain Cloudを使用しています。',
  ...
  "sp.upload_picker.question": "{selector} にアップロードするファイルを選択してください",
  "sp.upload_picker.choose_file": "ファイルを選択…",
  "sp.upload_picker.cancel": "キャンセル",
  "sp.upload_picker.selected": "選択したファイル: {name}（{size} バイト）",
