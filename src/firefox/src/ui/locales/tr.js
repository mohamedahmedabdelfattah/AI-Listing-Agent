...
export default {
  ...
  'ob.btn.start': 'Başla',
  'ob.cloud.body': 'WebBrain Cloud günlük ücretsiz payla hazır. Seçilen Cloud konuşmaları, WebBrain\'i Geliştir Yardımı varsayılan olarak açıkken WebBrain\'i geliştirmek için saklanabilir ve kullanılabilir. Bunu Ayarlar → Genel olarak kapatabilirsiniz.',
