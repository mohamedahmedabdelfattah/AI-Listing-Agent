...
export default {
  ...
  'ob.cloud.body': 'Ang WebBrain Cloud ay handa na may libreng araw-araw na alokasyon. Ang mga napiling Cloud na usapan ay maaaring manatili at gamitin upang mapahusay ang WebBrain habang ang Tulong sa Pagsasapa ng WebBrain ay naka-on sa default. Maaari mong ito sa Settings → General.',
  ...
  "sp.upload_picker.question": "Pumili ng file na ia-upload sa {selector}",
  "sp.upload_picker.choose_file": "Pumili ng File…",
  "sp.upload_picker.cancel": "Kanselahin",
  "sp.upload_picker.selected": "Napiling file: {name} ({size} bytes)",
