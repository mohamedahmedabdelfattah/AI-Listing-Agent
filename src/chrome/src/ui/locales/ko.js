...
export default {
  ...
  'ob.btn.start': '시작',
  'ob.cloud.body': 'WebBrain Cloud가 무료 일일 할당량으로 준비되었습니다. 선택한 Cloud 대화는 WebBrain 개선 도움이 기본적으로 켜져 있는 동안 WebBrain 개선을 위해 저장되고 사용될 수 있습니다. 설정 → 일반에서 끌 수 있습니다.',
  'ob.cloud.change': '변경',
  'ob.cloud.using': 'WebBrain Cloud를 사용 중입니다.',
  ...
  'st.display.auto_group_tabs.label': 'WebBrain 탭 그룹화',
  'st.display.auto_group_tabs.desc': '도구 모음, 컨텍스트 메뉴 또는 에이전트가 연 탭을 WebBrain이라는 브라우저 탭 그룹에 자동으로 배치합니다. 이 옵션을 꺼도 기존 그룹은 변경되지 않습니다.',
  ...
  'st.vision.local.desc': 'LiquidAI/LFM2.5-VL-450M-ONNX를 GPU에서 실행합니다. 스크린샷은 이 기기에만 남습니다. 처음 사용할 때 백그라운드에서 Hugging Face로부터 약 770 MB를 다운로드하여 로컬에 캐시합니다. 다운로드 중에 탭을 전환하거나 설정을 닫아도 됩니다. Chrome은 열어 두세요.',
  'st.vision.local.enable': '로컬 대체 모델 사용',
  'st.vision.local.disable': '로컬 대체 모델 사용 중지',
  'st.vision.local.saved': '로컬 비전 대체 모델이 활성화되었습니다.',
  'st.vision.local.testing': '로컬 비전을 불러와 테스트하는 중… 처음 사용할 때 백그라운드에서 약 770 MB를 다운로드합니다. 탭을 전환하거나 설정을 닫아도 됩니다. Chrome은 열어 두세요.',
  ...
  "sp.slash.watch": "조건이 충족될 때까지 이 페이지 감시",
  "sp.slash.watch_keep": "서로 다른 일치 후에도 계속 감시",
  "sp.slash.watch_secs": "확인 간격을 초 단위로 설정",
  "sp.slash.watch_long": "긴 감시 알림 사용",
  "sp.slash.watch_short": "짧은 감시 알림 사용",
  "sp.watch.created": "이 페이지를 {seconds}초마다 감시합니다.",
  "sp.watch.exists": "이 페이지는 이미 같은 조건으로 감시되고 있습니다.",
  "sp.watch.error": "감시를 만들 수 없습니다: {error}",
  ...
  "st.captcha.saved": "저장되었습니다. CapSolver가 활성화되었습니다.",
  ...
  'sp.scheduled.watch_keep': '일치할 때마다 계속 감시',
  ...
  'sp.plan.timed_out': '승인 시간이 초과되었습니다',
  ...
  'st.display.cloud_bridge.status_connected': '연결됨',
  'st.display.cloud_bridge.status_reconnecting': '다시 연결 중({attempt}번째 시도)…',
  'st.display.cloud_bridge.status_error': '연결 오류: {error}',
  'st.display.cloud_bridge.status_unreachable': '{url}에 연결할 수 없습니다. 해당 로컬 브리지 서비스를 시작하세요. 다시 시도 중…',
  ...
  'st.display.plan_before_act.desc': "Act 및 Dev 모드는 도구 실행 전에 항상 구조화된 의도 확인을 수행합니다. 시도(기본값)는 전체 계획도 만들지만 짧은 후속 요청에서는 최근 승인된 계획을 재사용할 수 있습니다. 엄격 모드는 매 턴 전체 계획을 만듭니다. 의도나 계획이 계속 유효하지 않으면 시도 모드는 한 번 더 시도한 뒤 경고를 표시하고 Act 모드로 계속하며, 엄격 모드는 도구 실행 전에 중지합니다.",
  ...
  'sp.plan.step_placeholder': '단계 작업',
  ...
  "sp.slash.delete_workflow": "ID로 저장된 워크플로 삭제",
  "sp.workflows.title_html": "<strong>저장된 워크플로</strong>",
  "sp.workflows.empty": "저장된 워크플로가 없습니다. 추적을 켜고 작업을 완료한 다음 /workflow --save <name>을 사용하세요.",
  "sp.workflows.item": "{id}  {name}  ({steps}단계, 매개변수 {parameters}개)",
  "sp.workflows.meta": "{id} · {steps}단계 · {parameters}개 매개변수",
  "sp.workflows.delete_confirm": "삭제 확인",
  "sp.workflows.rename": "이름 바꾸기",
  "sp.workflows.saved": "워크플로 “{name}”을 저장했습니다.",
  "sp.workflows.deleted": "워크플로 “{name}”을 삭제했습니다.",
  "sp.workflows.error": "워크플로 오류: {msg}",
  "sp.teach.started": "“{name}”을 학습 중입니다. 작업을 완료한 다음 /teach --end를 사용하세요.",
  "sp.teach.status": "“{name}” 학습 중: {count}개 작업을 캡처했습니다.",
  "sp.teach.inactive": "교사 모드가 활성화되어 있지 않습니다.",
  "sp.teach.saved": "“{name}” 워크플로를 {count}단계로 학습했습니다.",
  "sp.teach.already_active": "이 탭에서 교사 모드가 이미 활성화되어 있습니다.",
  "sp.teach.agent_running": "교사 모드를 시작하기 전에 실행 중인 에이전트를 중지하세요.",
  "sp.teach.capture_unavailable": "교사 모드에서 이 페이지를 캡처할 수 없습니다. 일반 http(s) 페이지를 열거나 새로고침한 후 다시 시도하세요.",
  "sp.workflows.reason.no_trace": "이 대화에서 성공한 기록 실행을 찾지 못했습니다. 추적을 켜고 작업을 완료한 다음 저장하세요.",
  ...
  "st.imageBudget.heading": "이미지 예산",
  "st.imageBudget.desc": "스크린샷 크기와 에이전트가 턴마다 비전용으로 캡처하는 횟수를 제어합니다. 세부도와 크기를 낮추면 작은 엔드포인트에서 비용과 지연이 줄고, 높이면 충실도가 유지됩니다. 기본값은 이전 동작과 같습니다.",
  "st.imageBudget.detail.label": "이미지 세부도",
  "st.imageBudget.detail.desc": "모델에 보내는 비전 이미지 세부도입니다. «high»는 더 많은 세부 유지(토큰·비용 증가); «low»는 더 작고 저렴한 이미지; «auto»는 제공자가 결정. 제공자에 따라 다릅니다.",
  "st.imageBudget.detail.high": "높음 (세부 많음, 비용 높음)",
  "st.imageBudget.detail.low": "낮음 (저렴, 세부 적음)",
  "st.imageBudget.detail.auto": "자동 (제공자 기본값)",
  "st.imageBudget.maxPerTurn.label": "턴당 최대 스크린샷",
  "st.imageBudget.maxPerTurn.desc": "에이전트가 한 턴에 비전용으로 자동 캡처할 수 있는 횟수(0 = 무제한). 낮을수록 비용이 줄고, 예산을 다 쓰면 해당 턴의 추가 자동 캡처는 건너뜁니다.",
  "st.imageBudget.maxPerTurn.unlimited": "무제한",
  "st.imageBudget.maxDimension.label": "최대 이미지 치수",
  "st.imageBudget.maxDimension.desc": "비전으로 보내는 스크린샷의 긴 변(너비 또는 높이) 픽셀 상한. 낮은 상한은 전송 전 축소로 토큰·비용을 줄이고, 높은 상한은 충실도를 유지합니다.",
  "st.imageBudget.warning": "⚠️ 이 설정은 비전용 스크린샷(자동 캡처, /screenshot, 전체 페이지, verify_form)에 적용됩니다. 수동으로 저장한 전체 해상도 이미지는 영향을 받지 않습니다. «Image detail»은 OpenAI 스타일 엔드포인트에서 적용되며 다른 제공자는 무시할 수 있습니다.",
  ...
  "st.sync.title": "암호화된 클라우드 동기화",
  "st.sync.lede_html": "<strong>WebBrain Cloud 회원 전용.</strong> 여러 기기에서 추억, 프로필 자동 완성, API 키 제공자 설정을 동기화합니다. 업로드하기 전에 모든 것이 동기화 비밀번호로 암호화됩니다. WebBrain은 이를 읽거나 복구할 수 없습니다. 채팅 기록과 OAuth 로그인은 동기화되지 않습니다.",
  "st.sync.email.label": "WebBrain Cloud 이메일",
  "st.sync.password.label": "암호화를 위한 동기화 비밀번호(12자 이상)",
  "st.sync.confirm.label": "동기화 비밀번호 확인",
  "st.sync.action.auth": "로그인 링크 보내기",
  "st.sync.action.enable": "암호화된 동기화 켜기",
  "st.sync.action.unlock": "암호화된 동기화 잠금 해제",
  "st.sync.action.now": "지금 동기화",
  "st.sync.action.lock": "잠금",
  "st.sync.action.change_password": "동기화 비밀번호 변경",
  "st.sync.action.disable": "이 기기에서 동기화 끄기",
  "st.sync.action.reset": "클라우드 사본을 이 장치로 교체",
  "st.sync.status.syncing": "암호화된 동기화가 업데이트 중입니다…",
  "st.sync.status.offline": "암호화된 동기화가 연결을 기다리고 있습니다.",
  "st.sync.status.subscription": "암호화된 동기화를 위해서는 WebBrain Cloud 멤버십이 필요합니다.",
  "st.sync.status.error": "암호화된 동기화에는 주의가 필요합니다.",
  "st.sync.status.auth_required": "암호화된 동기화를 사용하려면 WebBrain Cloud 이메일로 로그인하세요.",
  "st.sync.status.password_required": "로그인했습니다. 암호화된 동기화를 켜려면 동기화 비밀번호를 선택하세요.",
  "st.sync.status.unlocked": "이 기기에 암호화된 동기화가 켜져 있습니다.",
  "st.sync.status.locked": "암호화된 동기화가 잠겨 있습니다. 이 기기에서 잠금을 해제하려면 동기화 비밀번호를 입력하세요.",
  "st.sync.result.updated": "암호화된 동기화가 업데이트되었습니다.",
  "st.sync.result.current": "암호화된 동기화가 최신 상태입니다.",
  "st.sync.pending.syncing": "암호화된 클라우드 사본 동기화 중…",
  "st.sync.pending.syncing_short": "동기화 중…",
  "st.sync.error.generic": "암호화된 동기화 실패: {error}",
  "st.sync.error.unknown": "알 수 없는 오류",
  "st.sync.validation.email_required": "WebBrain Cloud 청구 이메일을 입력하세요.",
  "st.sync.validation.password_length": "12자 이상의 동기화 비밀번호를 사용하세요.",
  "st.sync.validation.confirm_required": "동기화 비밀번호를 확인하세요.",
  "st.sync.validation.password_mismatch": "동기화 비밀번호가 일치하지 않습니다.",
  "st.sync.prompt.new_password": "새 동기화 비밀번호",
  "st.sync.prompt.password": "{label}(12자 이상):",
  "st.sync.prompt.confirm_password": "동기화 비밀번호 확인:",
  "st.sync.prompt.current_password": "현재 동기화 비밀번호:",
  "st.sync.prompt.replacement_password": "대체 클라우드 사본에 대한 동기화 비밀번호",
  "st.sync.auth.check_email": "이메일을 확인하고 WebBrain Cloud 로그인 링크를 승인한 후 여기로 돌아오세요.",
  "st.sync.auth.success": "클라우드 동기화가 인증되었습니다. 비밀번호를 설정하고 동기화를 활성화하세요.",
  "st.sync.confirm.disable": "이 기기에서 암호화된 동기화를 끄시겠습니까? 로컬 데이터는 그대로 유지됩니다.",
