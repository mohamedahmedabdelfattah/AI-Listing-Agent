...
export default {
  ...
  'ob.btn.start': 'Mula',
  'ob.cloud.body': 'WebBrain Cloud sedia dengan elaun harian percuma. Perbincangan Cloud yang dipilih boleh disimpan dan digunakan untuk meningkatkan WebBrain semasa Bantu Tingkatkan WebBrain didayakan secara lalai. Anda boleh mematikannya di Tetapan → Umum.',
  'ob.cloud.change': 'Tukar',
  'ob.cloud.using': 'Menggunakan WebBrain Cloud.',
  ...
  "sp.slash.watch": "Pantau halaman ini sehingga syarat dipenuhi",
  "sp.slash.watch_keep": "Terus pantau selepas padanan yang berbeza",
  "sp.slash.watch_secs": "Tetapkan sela semakan dalam saat",
  "sp.slash.watch_long": "Gunakan amaran pantauan panjang",
  "sp.slash.watch_short": "Gunakan amaran pantauan pendek",
  "sp.watch.created": "Memantau halaman ini setiap {seconds} saat.",
  "sp.watch.exists": "Halaman ini sudah dipantau dengan syarat yang sama.",
  "sp.watch.error": "Tidak dapat mencipta pantauan: {error}",
  ...
  "st.captcha.saved": "Disimpan. CapSolver diaktifkan.",
  ...
  'sp.scheduled.watch_keep': 'terus memantau selepas setiap padanan',
  ...
  'st.display.cloud_bridge.status_connected': 'Disambungkan',
  'st.display.cloud_bridge.status_reconnecting': 'Menyambung semula (cubaan {attempt})…',
  'st.display.cloud_bridge.status_error': 'Ralat sambungan: {error}',
  'st.display.cloud_bridge.status_unreachable': 'Tidak dapat mencapai {url}. Mulakan perkhidmatan jambatan setempat yang sepadan; mencuba semula…',
  ...
  'st.display.plan_before_act.desc': "Mod Act dan Dev sentiasa menjalankan semakan niat berstruktur sebelum alatan. Cuba (lalai) turut membina rancangan penuh tetapi boleh menggunakan semula rancangan yang baru diluluskan untuk susulan ringkas; Ketat membina rancangan penuh setiap giliran. Cuba mengulang sekali, kemudian meneruskan dalam mod Act dengan amaran jika niat atau rancangan masih tidak sah; Ketat berhenti sebelum alatan.",
  ...
  'mic.granted': 'Kebenaran diberikan!',
  ...
  'sp.plan.reorder_hint': 'Seret nombor langkah untuk menyusun semula',
  'sp.plan.reorder_step': 'Seret untuk menyusun semula langkah {step}',
  'sp.plan.remove_step': 'Buang langkah',
  'sp.plan.empty_steps': 'Tambah sekurang-kurangnya satu langkah sebelum meluluskan.',
  'sp.plan.summary_placeholder': 'Ringkasan rancangan',
  ...
  "sp.slash.delete_workflow": "Padam aliran kerja tersimpan mengikut ID",
  "sp.workflows.title_html": "<strong>Aliran kerja tersimpan</strong>",
  "sp.workflows.empty": "Belum ada aliran kerja tersimpan. Lengkapkan tugas dengan penjejakan, kemudian gunakan /workflow --save <name>.",
  "sp.workflows.item": "{id}  {name}  ({steps} langkah, {parameters} parameter)",
  "sp.workflows.meta": "{id} · {steps} langkah · {parameters} parameter",
  "sp.workflows.delete_confirm": "Sahkan pemadaman",
  "sp.workflows.rename": "Namakan semula",
  "sp.workflows.saved": "Aliran kerja “{name}” disimpan.",
  "sp.workflows.deleted": "Aliran kerja “{name}” dipadam.",
  "sp.workflows.error": "Ralat aliran kerja: {msg}",
  "sp.teach.started": "Mengajar “{name}”. Lakukan aliran kerja, kemudian gunakan /teach --end.",
  "sp.teach.status": "Mengajar “{name}”: {count} tindakan dirakam.",
  "sp.teach.inactive": "Mod pengajaran tidak aktif.",
  "sp.teach.saved": "Aliran kerja “{name}” dipelajari dengan {count} langkah.",
  "sp.teach.already_active": "Mod pengajaran sudah aktif dalam tab ini.",
  "sp.teach.agent_running": "Hentikan ejen yang sedang berjalan sebelum memulakan mod pengajaran.",
  "sp.teach.capture_unavailable": "Mod pengajaran tidak dapat merakam halaman ini. Buka atau muat semula halaman http(s) biasa dan cuba lagi.",
  "sp.workflows.reason.no_trace": "Tiada pelaksanaan berjaya yang direkodkan dalam perbualan ini. Aktifkan penjejakan, lengkapkan tugas, kemudian simpannya.",
  ...
  "st.imageBudget.heading": "Bajet imej",
  "st.imageBudget.desc": "Mengawal saiz tangkapan skrin dan berapa kali ejen menangkap untuk visi setiap pusingan. Perincian dan dimensi lebih rendah mengurangkan kos dan latensi pada endpoint kecil; lebih tinggi mengekalkan ketepatan. Lalai sepadan dengan tingkah laku sebelumnya.",
  "st.imageBudget.detail.label": "Perincian imej",
  "st.imageBudget.detail.desc": "Perincian imej visi yang dihantar kepada model. «high» mengekalkan lebih banyak perincian (lebih banyak token dan kos); «low» menghantar imej lebih kecil dan murah; «auto» membiarkan pembekal memutuskan. Bergantung kepada pembekal.",
  "st.imageBudget.detail.high": "Tinggi (lebih perincian, lebih kos)",
  "st.imageBudget.detail.low": "Rendah (lebih murah, kurang perincian)",
  "st.imageBudget.detail.auto": "Auto (lalai pembekal)",
  "st.imageBudget.maxPerTurn.label": "Maks. tangkapan setiap pusingan",
  "st.imageBudget.maxPerTurn.desc": "Berapa banyak tangkapan automatik yang boleh diambil ejen untuk visi dalam satu pusingan (0 = tanpa had). Nilai lebih rendah mengurangkan kos; selepas bajet habis, tangkapan automatik seterusnya dalam pusingan itu dilangkau.",
  "st.imageBudget.maxPerTurn.unlimited": "Tanpa had",
  ...
  'st.skills.cws.heading': 'Persediaan penerbitan Chrome Web Store',
  'st.skills.cws.desc_html': 'Tetapan ini hanya muncul semasa kemahiran penerbitan berpakej diaktifkan. Cipta aplikasi web OAuth dalam Google Cloud, aktifkan Chrome Web Store API, dan daftarkan <code>http://localhost:1457/auth/callback</code> sebagai URI pengalihan yang dibenarkan. Kelayakan, token dan bait ZIP kekal disimpan secara tempatan dalam sambungan dan tidak pernah disertakan dalam permintaan model ataujejakan.',
  'st.skills.cws.publisher_id': 'ID Penerbit',
  'st.skills.cws.item_id': 'ID Item (ID sambungan 32 aksara)',
  'st.skills.cws.oauth_client_id': 'ID klien OAuth Google',
  'st.skills.cws.oauth_client_secret': 'Rahsia klien OAuth Google',
  'st.skills.cws.redirect_help': 'URI pengalihan yang dibenarkan: http://localhost:1457/auth/callback',
  'st.skills.cws.save': 'Simpan persediaan',
  'st.skills.cws.connect': 'Sambung Google',
  'st.skills.cws.signout': 'Putuskan',
  'st.skills.cws.saved': 'Persediaan Chrome Web Store disimpan secara tempatan.',
  'st.skills.cws.connected': 'Google OAuth disambungkan untuk akses Chrome Web Store.',
  'st.skills.cws.disconnected': 'Google OAuth tidak disambungkan.',
  'st.skills.cws.signed_out': 'Token Google OAuth dibuang.',
  'st.skills.cws.connect_failed': 'Tidak dapat menyambungkan Google OAuth.',
  'st.skills.cws.package': 'Pakej pelepasan (.zip)',
  'st.skills.cws.package_empty': 'Tiada ZIP pelepasan dipilih.',
  'st.skills.cws.package_selected': '{name} · {size} KB · disimpan tempatan',
  'st.skills.cws.package_ready': 'ZIP pelepasan sedia untuk alat muat naik yang dipercayai.',
  'st.skills.cws.clear_package': 'Padam ZIP dipilih',
  ...
  "st.sync.title": "Penyegerakan Awan Disulitkan",
  "st.sync.lede_html": "<strong>Ahli WebBrain Cloud sahaja.</strong> Segerakkan kenangan, autoisi profil dan tetapan pembekal kunci API merentas peranti. Semuanya disulitkan dengan kata laluan penyegerakan anda sebelum memuat naik. WebBrain tidak boleh membaca atau memulihkannya. Sejarah sembang dan log masuk OAuth tidak disegerakkan.",
  "st.sync.email.label": "E-mel WebBrain Cloud",
  "st.sync.password.label": "Segerakkan kata laluan untuk penyulitan (12+ aksara)",
  "st.sync.confirm.label": "Sahkan kata laluan penyegerakan",
  "st.sync.action.auth": "Hantar pautan log masuk",
  "st.sync.action.enable": "Hidupkan penyegerakan yang disulitkan",
  "st.sync.action.unlock": "Buka kunci penyegerakan yang disulitkan",
  "st.sync.action.now": "Segerakkan sekarang",
  "st.sync.action.lock": "Kunci",
  "st.sync.action.change_password": "Tukar kata laluan penyegerakan",
  "st.sync.action.disable": "Matikan penyegerakan pada peranti ini",
  "st.sync.action.reset": "Gantikan salinan awan dengan peranti ini",
  "st.sync.status.syncing": "Penyegerakan yang disulitkan sedang mengemas kini…",
  "st.sync.status.offline": "Penyegerakan yang disulitkan sedang menunggu sambungan.",
  "st.sync.status.subscription": "Keahlian WebBrain Cloud diperlukan untuk penyegerakan yang disulitkan.",
  "st.sync.status.error": "Penyegerakan yang disulitkan memerlukan perhatian.",
  "st.sync.status.auth_required": "Log masuk dengan e-mel WebBrain Cloud anda untuk menggunakan penyegerakan yang disulitkan.",
  "st.sync.status.password_required": "Log masuk. Pilih kata laluan penyegerakan untuk menghidupkan penyegerakan yang disulitkan.",
  "st.sync.status.unlocked": "Penyegerakan yang disulitkan dihidupkan untuk peranti ini.",
  "st.sync.status.locked": "Penyegerakan yang disulitkan dikunci. Masukkan kata laluan penyegerakan anda untuk membuka kuncinya pada peranti ini.",
  "st.sync.result.updated": "Penyegerakan yang disulitkan dikemas kini.",
  "st.sync.result.current": "Penyegerakan yang disulitkan adalah terkini.",
  "st.sync.pending.syncing": "Menyegerakkan salinan awan yang disulitkan…",
  "st.sync.pending.syncing_short": "Menyegerakkan…",
  "st.sync.error.generic": "Penyegerakan yang disulitkan gagal: {error}",
  "st.sync.error.unknown": "Ralat tidak diketahui",
  "st.sync.validation.email_required": "Masukkan e-mel pengebilan WebBrain Cloud anda.",
  "st.sync.validation.password_length": "Gunakan kata laluan penyegerakan sekurang-kurangnya 12 aksara.",
  "st.sync.validation.confirm_required": "Sahkan kata laluan penyegerakan.",
  "st.sync.validation.password_mismatch": "Kata laluan penyegerakan tidak sepadan.",
  "st.sync.prompt.new_password": "Kata laluan penyegerakan baharu",
  "st.sync.prompt.password": "{label} (12+ aksara):",
  "st.sync.prompt.confirm_password": "Sahkan kata laluan penyegerakan:",
  "st.sync.prompt.current_password": "Kata laluan penyegerakan semasa:",
  "st.sync.prompt.replacement_password": "Segerakkan kata laluan untuk salinan awan gantian",
  "st.sync.auth.check_email": "Semak e-mel anda, luluskan pautan log masuk WebBrain Cloud, kemudian kembali ke sini.",
  "st.sync.auth.success": "Cloud Sync disahkan. Tetapkan kata laluan dan dayakan penyegerakan.",
  "st.sync.confirm.disable": "Matikan penyegerakan yang disulitkan pada peranti ini? Data tempatan akan kekal.",
