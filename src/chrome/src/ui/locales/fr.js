...
export default {
  ...
  'install.installed': 'WebBrain installé',
  'install.checking': 'Vérification de votre navigateur…',
  'install.ready': 'Prêt',
  'install.extensions': 'Extensions',
  'install.eyebrow': 'Une petite étape de configuration',
  'install.title': 'Gardez WebBrain à portée de clic',
  'install.intro': 'Votre navigateur peut masquer les extensions récemment installées. Gardez WebBrain visible pour pouvoir l’ouvrir facilement.',
  'install.open_extensions.title': 'Ouvrez Extensions',
  'install.open_extensions.body': 'Ouvrez les commandes d’extensions du navigateur près de la barre d’adresse.',
  'install.keep_visible.title': 'Gardez WebBrain visible',
  'install.keep_visible.body': 'Repérez WebBrain et choisissez l’option pour l’épingler, l’afficher ou le garder dans la barre d’outils.',
  'install.open.title': 'Ouvrez-le depuis n’importe quelle page',
  'install.open.body': 'Sélectionnez l’icône WebBrain',
  'install.open.shortcut_html': 'Ou appuyez sur <kbd>Alt</kbd><span>+</span><kbd>Maj</kbd><span>+</span><kbd>W</kbd> à tout moment.',
  'install.footer': 'Cette action ne peut pas être automatique : votre navigateur vous laisse choisir les éléments de la barre d’outils.',
  'install.done': 'Compris',
  'install.browser.detected': '{browser} détecté',
  'install.open_panel': 'Ouvrir le panneau latéral',
  'install.open_sidebar': 'Ouvrir la barre latérale',
  'install.open_panel.body': 'Ouvrez WebBrain à côté de cette page pour terminer la configuration.',
  'install.pin.title': 'Épinglez WebBrain à la barre d’outils',
  'install.pin.body': 'Cliquez sur l’épingle dans l’en-tête du panneau latéral ci-dessus. WebBrain sera ajouté à la barre d’outils du navigateur pour un accès en un clic.',
  'install.pin.next': 'Une fois le panneau latéral ouvert, utilisez l’épingle dans son en-tête pour ajouter WebBrain à la barre d’outils du navigateur.',
  'install.pin.confirm': 'WebBrain est épinglé',
  'install.pin.skip': 'Ignorer cette étape',
  'install.firefox_pin.body': 'Pour garder WebBrain à portée de main, ouvrez les extensions Firefox, sélectionnez l’engrenage à côté de WebBrain, puis Épingler à la barre d’outils.',
  'install.open_failed_chromium': 'Le panneau latéral ne s’est pas ouvert. Appuyez sur Alt+Maj+W ou ouvrez le menu Extensions du navigateur et sélectionnez WebBrain.',
  'install.open_failed_firefox': 'La barre latérale ne s’est pas ouverte. Ouvrez les extensions Firefox et sélectionnez WebBrain.',
  ...
  'ob.cloud.body': 'WebBrain Cloud est prêt avec une allocation quotidienne gratuite. Les conversations Cloud sélectionnées peuvent être conservées et utilisées pour améliorer WebBrain pendant que Aider à améliorer WebBrain est activé par défaut. Vous pouvez le désactiver dans Paramètres → Général.',
  'ob.cloud.change': 'Changer',
  'ob.cloud.using': 'Utilisation de WebBrain Cloud.',
  ...
  'sp.btn.expand': 'Ouvrir dans une nouvelle fenêtre',
  'sp.btn.send': 'Envoyer',
  ...
  "sp.slash.watch": "Surveiller cette page jusqu’à ce qu’une condition soit remplie",
  "sp.slash.watch_keep": "Continuer après des correspondances distinctes",
  "sp.slash.watch_secs": "Définir l’intervalle de vérification en secondes",
  "sp.slash.watch_long": "Utiliser une alerte de surveillance longue",
  "sp.slash.watch_short": "Utiliser une alerte de surveillance courte",
  "sp.watch.created": "Surveillance de cette page toutes les {seconds} secondes.",
  "sp.watch.exists": "Cette page est déjà surveillée avec la même condition.",
  "sp.watch.error": "Impossible de créer la surveillance : {error}",
  ...
  "sp.screenshot.save_as": "Enregistrer sous…",
  "sp.screenshot.saving": "Ouverture…",
  "sp.screenshot.save_failed": "Impossible d’enregistrer la capture d’écran : {msg}",
  ...
  "st.display.download_directory.label": "Dossier de téléchargement",
  "st.display.download_directory.desc": "Sous-dossier facultatif dans le dossier Téléchargements du navigateur ou du système. Laissez vide pour utiliser la valeur par défaut du système.",
  ...
  "st.providers.api_key_warning": "Enregistré, mais cela ne fonctionnera pas sans une clé valide. Cliquez sur Tester la connexion et vérifiez que le message de réussite vert apparaît.",
  "st.providers.ollama_warning.label": "FAQ Ollama",
  "st.providers.ollama_warning.title": "Pourquoi Ollama sur localhost renvoie-t-il une erreur 403 ?",
  "st.providers.ollama_warning.body": "Les versions récentes d’Ollama peuvent refuser les requêtes provenant d’extensions de navigateur, même si Ollama s’exécute sur la même machine. WebBrain envoie une origine telle que chrome-extension://… ou moz-extension://…, et Ollama peut répondre 403 si ces origines ne sont pas autorisées.",
  "st.providers.ollama_warning.restart": "Quittez toute application de bureau Ollama qui utilise déjà le port 11434, puis démarrez Ollama avec la commande suivante :",
  "st.providers.ollama_warning.base_url": "Conservez l’URL de base Ollama de WebBrain sur http://localhost:11434/v1. Les tests curl dans le terminal peuvent fonctionner sans ce réglage, car ils n’envoient pas d’origine d’extension de navigateur.",
  "st.providers.ollama_warning.link": "Lire l’annonce d’intégration d’Ollama",
  ...
  "st.captcha.saved": "Enregistré. CapSolver est activé.",
  ...
  'sp.scheduled.watch_once': 's’arrête après la première correspondance',
  'sp.scheduled.watch_keep': 'continue la surveillance après chaque correspondance',
  ...
  'sp.plan.timed_out': 'Le délai d’approbation a expiré',
  ...
  'st.display.cloud_bridge.invalid_url': 'Utilisez une URL ws:// locale avec 127.0.0.1, localhost ou ::1.',
  'st.display.cloud_bridge.status_disabled': 'Pont désactivé',
  'st.display.cloud_bridge.status_connecting': 'Connexion…',
  'st.display.cloud_bridge.status_connected': 'Connecté',
  'st.display.cloud_bridge.status_reconnecting': 'Reconnexion (tentative {attempt})…',
  'st.display.cloud_bridge.status_error': 'Erreur de connexion : {error}',
  'st.display.cloud_bridge.status_unreachable': 'Impossible d’atteindre {url}. Démarrez le service de pont local correspondant ; nouvelle tentative…',
  ...
  'st.display.always_allow_api_mutations.label': "Toujours autoriser les mutations API",
  'st.display.always_allow_api_mutations.desc': "Autoriser WebBrain à utiliser POST, PUT, PATCH et DELETE via fetch_url ou research_url sans exiger /allow-api dans chaque conversation. Les directives UI-d’abord et les confirmations restent applicables. Désactivé par défaut.",
  ...
  'st.display.plan_before_act.desc': "Les modes Act et Dev effectuent toujours une vérification structurée de l’intention avant les outils. Essai (par défaut) crée aussi des plans complets, mais peut réutiliser un plan récemment approuvé pour un bref suivi ; Strict crée un plan complet à chaque tour. Essai retente une fois puis, si l’intention ou le plan reste invalide, continue en mode Act avec un avertissement ; Strict s’arrête avant les outils.",
  ...
  "sp.record.full_screen_started_html": "L’enregistrement de l’écran/la fenêtre a démarré. Arrêtez-le avec <strong>Arrêter</strong> dans la bannière d’enregistrement, en appuyant deux fois sur <code>Escape</code> dans WebBrain ou dans une page du navigateur, ou avec le contrôle Arrêter le partage de Chrome. Ajoutez <code>--hide-recording-indicator</code> pour que la bannière n’apparaisse pas dans la vidéo.",
  "sp.record.full_screen_started_hidden_html": "L’enregistrement de l’écran/la fenêtre a démarré. Appuyez deux fois sur <code>Escape</code> dans WebBrain ou dans une page du navigateur pour l’arrêter, ou utilisez le contrôle Arrêter le partage de Chrome.",
  ...
  "sp.slash.delete_workflow": "Supprimer un workflow enregistré par ID",
  "sp.workflows.title_html": "<strong>Workflows enregistrés</strong>",
  "sp.workflows.empty": "Aucun workflow enregistré. Terminez une tâche tracée, puis utilisez /workflow --save <name>.",
  "sp.workflows.item": "{id}  {name}  ({steps} étapes, {parameters} paramètres)",
  "sp.workflows.meta": "{id} · {steps} étapes · {parameters} paramètres",
  "sp.workflows.delete_confirm": "Confirmer la suppression",
  "sp.workflows.rename": "Renommer",
  "sp.workflows.saved": "Workflow « {name} » enregistré.",
  "sp.workflows.deleted": "Workflow « {name} » supprimé.",
  "sp.workflows.error": "Erreur de workflow : {msg}",
  "sp.teach.started": "Apprentissage de « {name} ». Effectuez le workflow, puis utilisez /teach --end.",
  "sp.teach.status": "Apprentissage de « {name} » : {count} actions capturées.",
  "sp.teach.inactive": "Le mode d’apprentissage n’est pas actif.",
  "sp.teach.saved": "Workflow « {name} » appris avec {count} étapes.",
  "sp.teach.already_active": "Le mode d’apprentissage est déjà actif dans cet onglet.",
  "sp.teach.agent_running": "Arrêtez l’exécution active de l’agent avant de lancer le mode d’apprentissage.",
  "sp.teach.capture_unavailable": "Le mode d’apprentissage ne peut pas capturer cette page. Ouvrez ou rechargez une page http(s) normale, puis réessayez.",
  "sp.workflows.reason.no_trace": "Aucune exécution réussie et tracée dans cette conversation. Activez le traçage, terminez la tâche, puis enregistrez-la.",
  ...
  'st.providers.compat.preset': 'Préréglage de compatibilité',
  'st.providers.compat.reasoning': 'Raisonnement',
  'st.providers.compat.system_role': 'Rôle du prompt système',
  'st.providers.compat.token_field': 'Champ de limite de tokens',
  'st.providers.compat.extra_body': 'Corps de requête personnalisé (JSON)',
  'st.providers.compat.extra_body_help': 'Fusionné après le préréglage. Les remplacements WebBrain par appel restent prioritaires. Les champs model, messages, tools, stream et de limite de tokens sont protégés.',
  'st.providers.compat.extra_body_placeholder': '{"chat_template_kwargs":{"enable_thinking":true}}',
  'st.providers.compat.reset': 'Réinitialiser en automatique',
  'st.providers.compat.summary': '{preset} · raisonnement {reasoning} · rôle {role} · {tokens}{extra}',
  'st.providers.compat.summary_extra': ' · {count} champ personnalisé',
  'st.providers.compat.summary_extra_plural': ' · {count} champs personnalisés',
  'st.providers.compat.auto_detected': 'Auto → {preset}',
  'st.providers.compat.provider_default': 'valeur par défaut du fournisseur',
  ...
  'st.providers.compat.value.custom': 'Personnalisé',
  'st.providers.compat.value.off': 'Désactivé',
  'st.providers.compat.value.minimal': 'Minimal',
  'st.providers.compat.value.low': 'Faible',
  'st.providers.compat.value.medium': 'Moyen',
  'st.providers.compat.value.high': 'Élevé',
  'st.providers.compat.value.xhigh': 'XÉlevé',
  ...
  "st.sync.title": "Synchronisation cloud cryptée",
  "st.sync.lede_html": "<strong>Membres WebBrain Cloud uniquement.</strong> Synchronisez les mémoires, le remplissage automatique du profil et les paramètres du fournisseur de clé API sur tous les appareils. Tout est crypté avec votre mot de passe de synchronisation avant le téléchargement. WebBrain ne peut pas le lire ou le récupérer. L'historique des discussions et les connexions OAuth ne sont pas synchronisés.",
  "st.sync.email.label": "E-mail WebBrain Cloud",
  "st.sync.password.label": "Mot de passe de synchronisation pour le cryptage (12+ caractères)",
  "st.sync.confirm.label": "Confirmer le mot de passe de synchronisation",
  "st.sync.action.auth": "Envoyer le lien de connexion",
  "st.sync.action.enable": "Activer la synchronisation chiffrée",
  "st.sync.action.unlock": "Débloquez la synchronisation cryptée",
  "st.sync.action.now": "Synchronisez maintenant",
  "st.sync.action.lock": "Verrouiller",
  "st.sync.action.change_password": "Changer le mot de passe de synchronisation",
  "st.sync.action.disable": "Désactiver la synchronisation sur cet appareil",
  "st.sync.action.reset": "Remplacer la copie cloud par cet appareil",
  "st.sync.status.syncing": "La synchronisation cryptée est en cours de mise à jour…",
  "st.sync.status.offline": "La synchronisation cryptée attend une connexion.",
  "st.sync.status.subscription": "L'adhésion à WebBrain Cloud est requise pour la synchronisation cryptée.",
  "st.sync.status.error": "La synchronisation cryptée nécessite votre attention.",
  "st.sync.status.auth_required": "Connectez-vous avec votre adresse e-mail WebBrain Cloud pour utiliser la synchronisation cryptée.",
  "st.sync.status.password_required": "Connecté. Choisissez un mot de passe de synchronisation pour activer la synchronisation cryptée.",
  "st.sync.status.unlocked": "La synchronisation chiffrée est activée pour cet appareil.",
  "st.sync.status.locked": "La synchronisation cryptée est verrouillée. Entrez votre mot de passe de synchronisation pour le déverrouiller sur cet appareil.",
  "st.sync.result.updated": "Synchronisation cryptée mise à jour.",
  "st.sync.result.current": "La synchronisation cryptée est à jour.",
  "st.sync.pending.syncing": "Synchronisation de la copie cloud cryptée…",
  "st.sync.pending.syncing_short": "Synchronisation…",
  "st.sync.error.generic": "Échec de la synchronisation chiffrée : {error}",
  "st.sync.error.unknown": "Erreur inconnue",
  "st.sync.validation.email_required": "Saisissez votre e-mail de facturation WebBrain Cloud.",
  "st.sync.validation.password_length": "Utilisez un mot de passe de synchronisation d'au moins 12 caractères.",
  "st.sync.validation.confirm_required": "Confirmez le mot de passe de synchronisation.",
  "st.sync.validation.password_mismatch": "Les mots de passe de synchronisation ne correspondent pas.",
  "st.sync.prompt.new_password": "Nouveau mot de passe de synchronisation",
  "st.sync.prompt.password": "{label} (12+ caractères) :",
  "st.sync.prompt.confirm_password": "Confirmez le mot de passe de synchronisation :",
  "st.sync.prompt.current_password": "Mot de passe de synchronisation actuel :",
  "st.sync.prompt.replacement_password": "Mot de passe de synchronisation pour la copie cloud de remplacement",
  "st.sync.auth.check_email": "Vérifiez votre courrier électronique, approuvez le lien de connexion WebBrain Cloud, puis revenez ici.",
  "st.sync.auth.success": "Cloud Sync authentifié. Définissez un mot de passe et activez la synchronisation.",
  "st.sync.confirm.disable": "Désactiver la synchronisation chiffrée sur cet appareil ? Les données locales resteront.",
