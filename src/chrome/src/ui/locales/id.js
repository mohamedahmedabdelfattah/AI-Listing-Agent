...
export default {
  ...
  'st.display.cloud_bridge.status_connected': 'Terhubung',
  'st.display.cloud_bridge.status_reconnecting': 'Menghubungkan ulang (percobaan {attempt})…',
  'st.display.cloud_bridge.status_error': 'Kesalahan koneksi: {error}',
  'st.display.cloud_bridge.status_unreachable': 'Tidak dapat menjangkau {url}. Jalankan layanan bridge lokal yang sesuai; mencoba lagi…',
