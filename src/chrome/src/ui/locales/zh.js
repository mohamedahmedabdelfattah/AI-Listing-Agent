...
export default {
  ...
  'ob.btn.skip': '暂时跳过',
  'ob.btn.start': '开始',
  'ob.cloud.body': 'WebBrain Cloud 已准备好每日免费配额。选定的 Cloud 对话可能会被保留并用于改进 WebBrain，而帮助改进 WebBrain 默认情况下处于开启状态。您可以在设置 → 常规中将其关闭。',
  'ob.cloud.change': '更改',
  'ob.cloud.using': '正在使用 WebBrain Cloud。',
  ...
  'tool.done': '收尾中',
  'sp.tool.done.completed': ' 完成',
  'sp.tool.done.rejected': ' 完成（已拒绝）',
  'sp.tool.done.failed': ' 完成（失败）',
  ...
  "sp.slash.watch": "监视此页面直到满足条件",
  "sp.slash.watch_keep": "在不同匹配发生后继续监视",
  "sp.slash.watch_secs": "设置轮询间隔（秒）",
  "sp.slash.watch_long": "使用较长的监视提示音",
  "sp.slash.watch_short": "使用较短的监视提示音",
  "sp.watch.created": "正在每 {seconds} 秒监视此页面。",
  "sp.watch.exists": "此页面已在使用相同条件进行监视。",
  "sp.watch.error": "无法创建监视任务：{error}",
  ...
  "st.captcha.clear": "清除",
  "st.captcha.saved": "已保存。CapSolver 已启用。",
  ...
  'sp.scheduled.watch_keep': '每次匹配后继续监视',
  ...
  'st.display.cloud_bridge.status_disabled': '桥接已禁用',
  'st.display.cloud_bridge.status_connecting': '正在连接…',
  'st.display.cloud_bridge.status_connected': '已连接',
  'st.display.cloud_bridge.status_reconnecting': '正在重新连接（第 {attempt} 次）…',
  'st.display.cloud_bridge.status_error': '连接错误：{error}',
  'st.display.cloud_bridge.status_unreachable': '无法连接到 {url}。请启动对应的本地桥接服务；正在重试…',
  ...
  "sp.record.full_screen_started_html": "屏幕/窗口录制已开始。可点击录制横幅上的<strong>停止</strong>按钮、在 WebBrain 或浏览器页面中按两次 <code>Escape</code>，或使用 Chrome 的停止共享控件来停止。添加 <code>--hide-recording-indicator</code> 可让横幅不出现在录制内容中。",
  "sp.record.full_screen_started_hidden_html": "屏幕/窗口录制已开始。要停止，请在 WebBrain 或浏览器页面中按两次 <code>Escape</code>，或使用 Chrome 的停止共享控件。",
  "sp.btn.attach": "附加文件",
  "sp.btn.mic": "语音输入",
  ...
  "sp.slash.delete_workflow": "按 ID 删除已保存的工作流",
  "sp.workflows.title_html": "<strong>已保存的工作流</strong>",
  "sp.workflows.empty": "尚无已保存的工作流。请在启用跟踪后完成任务，然后使用 /workflow --save <name>。",
  "sp.workflows.item": "{id}  {name} （{steps} 个步骤，{parameters} 个参数）",
  "sp.workflows.meta": "{id} · {steps} 个步骤 · {parameters} 个参数",
  "sp.workflows.delete_confirm": "确认删除",
  "sp.workflows.rename": "重命名",
  "sp.workflows.saved": "已保存工作流“{name}”。",
  "sp.workflows.deleted": "已删除工作流“{name}”。",
  "sp.workflows.error": "工作流错误：{msg}",
  "sp.teach.started": "正在示教“{name}”。请完成工作流，然后使用 /teach --end。",
  "sp.teach.status": "正在示教“{name}”：已捕获 {count} 个操作。",
  "sp.teach.inactive": "示教模式未启用。",
  "sp.teach.saved": "已学习工作流“{name}”，共 {count} 个步骤。",
  "sp.teach.already_active": "此标签页已启用示教模式。",
  "sp.teach.agent_running": "请先停止当前 Agent 运行，再启动示教模式。",
  "sp.teach.capture_unavailable": "示教模式无法捕获此页面。请打开或重新加载普通 http(s) 页面后重试。",
  "sp.workflows.reason.no_trace": "当前对话中没有成功且已记录的运行。请启用跟踪、完成任务，然后保存。",
  ...
  "st.imageBudget.heading": "图像预算",
  "st.imageBudget.desc": "控制截图大小以及代理每轮为视觉模型捕获的次数。更低的细节与尺寸可降低小端点的成本与延迟；更高则保留保真度。默认值与先前行为一致。",
  "st.imageBudget.detail.label": "图像细节",
  "st.imageBudget.detail.desc": "发送给模型的视觉图像细节。「high」保留更多细节（更多 token 与成本）；「low」发送更小、更便宜的图像；「auto」由提供商决定。取决于提供商。",
  "st.imageBudget.detail.high": "高（更多细节，更高成本）",
  "st.imageBudget.detail.low": "低（更便宜，更少细节）",
  "st.imageBudget.detail.auto": "自动（提供商默认）",
  "st.imageBudget.maxPerTurn.label": "每轮最大截图数",
  "st.imageBudget.maxPerTurn.desc": "代理在单轮中可为视觉捕获的自动截图数量（0 = 无限制）。较低值可降低成本；预算用尽后，该轮将不再进行自动截图。",
  "st.imageBudget.maxPerTurn.unlimited": "无限制",
  ...
  'st.skills.cws.heading': 'Chrome Web Store 发布设置',
  'st.skills.cws.desc_html': '这些设置仅在启用打包发布技能时显示。在 Google Cloud 中创建 OAuth Web 应用，启用 Chrome Web Store API，并注册 <code>http://localhost:1457/auth/callback</code> 为授权重定向 URI。凭据、令牌和 ZIP 字节始终存储在扩展本地存储中，永远不会包含在模型提示或跟踪中。',
  'st.skills.cws.publisher_id': '发布者 ID',
  'st.skills.cws.item_id': '项目 ID（32 位扩展 ID）',
  'st.skills.cws.oauth_client_id': 'Google OAuth 客户端 ID',
  'st.skills.cws.oauth_client_secret': 'Google OAuth 客户端密钥',
  'st.skills.cws.redirect_help': '授权重定向 URI：http://localhost:1457/auth/callback',
  'st.skills.cws.save': '保存设置',
  'st.skills.cws.connect': '连接 Google',
  'st.skills.cws.signout': '断开连接',
  'st.skills.cws.saved': 'Chrome Web Store 设置已保存到本地。',
  'st.skills.cws.connected': 'Google OAuth 已连接，可访问 Chrome Web Store。',
  'st.skills.cws.disconnected': 'Google OAuth 未连接。',
  'st.skills.cws.signed_out': '已移除 Google OAuth 令牌。',
  'st.skills.cws.connect_failed': '无法连接 Google OAuth。',
  'st.skills.cws.package': '发布包 (.zip)',
  'st.skills.cws.package_empty': '未选择发布 ZIP。',
  'st.skills.cws.package_selected': '{name} · {size} KB · 本地存储',
  'st.skills.cws.package_ready': '发布 ZIP 已准备好使用可信上传工具。',
  'st.skills.cws.clear_package': '清除选中的 ZIP',
  ...
  "st.sync.title": "加密云同步",
  "st.sync.lede_html": "<strong>仅限 WebBrain Cloud 会员。</strong>跨设备同步内存、个人资料自动填充和 API 密钥提供商设置。上传之前，所有内容都会使用您的同步密码进行加密。 WebBrain 无法读取或恢复它。聊天历史记录和 OAuth 登录不同步。",
  "st.sync.email.label": "WebBrain 云电子邮件",
  "st.sync.password.label": "同步加密密码（12+字符）",
  "st.sync.confirm.label": "确认同步密码",
  "st.sync.action.auth": "发送登录链接",
  "st.sync.action.enable": "开启加密同步",
  "st.sync.action.unlock": "解锁加密同步",
  "st.sync.action.now": "立即同步",
  "st.sync.action.lock": "锁",
  "st.sync.action.change_password": "更改同步密码",
  "st.sync.action.disable": "关闭此设备上的同步",
  "st.sync.action.reset": "使用此设备替换云副本",
  "st.sync.status.syncing": "加密同步正在更新...",
  "st.sync.status.offline": "加密同步正在等待连接。",
  "st.sync.status.subscription": "加密同步需要 WebBrain Cloud 会员资格。",
  "st.sync.status.error": "加密同步需要注意。",
  "st.sync.status.auth_required": "使用您的 WebBrain Cloud 电子邮件登录以使用加密同步。",
  "st.sync.status.password_required": "已登录。选择同步密码以打开加密同步。",
  "st.sync.status.unlocked": "此设备已启用加密同步。",
  "st.sync.status.locked": "加密同步已锁定。输入您的同步密码以在此设备上解锁。",
  "st.sync.result.updated": "已更新加密同步。",
  "st.sync.result.current": "加密同步是最新的。",
  "st.sync.pending.syncing": "正在同步加密云副本...",
  "st.sync.pending.syncing_short": "正在同步...",
  "st.sync.error.generic": "加密同步失败：{error}",
  "st.sync.error.unknown": "未知错误",
  "st.sync.validation.email_required": "输入您的 WebBrain Cloud 账单电子邮件。",
  "st.sync.validation.password_length": "使用至少 12 个字符的同步密码。",
  "st.sync.validation.confirm_required": "确认同步密码。",
  "st.sync.validation.password_mismatch": "同步密码不匹配。",
  "st.sync.prompt.new_password": "新的同步密码",
  "st.sync.prompt.password": "{label}（12+字符）：",
  "st.sync.prompt.confirm_password": "确认同步密码：",
  "st.sync.prompt.current_password": "当前同步密码：",
  "st.sync.prompt.replacement_password": "替换云副本的同步密码",
  "st.sync.auth.check_email": "检查您的电子邮件，批准 WebBrain Cloud 登录链接，然后返回此处。",
  "st.sync.auth.success": "云同步已通过身份验证。设置密码并启用同步。",
  "st.sync.confirm.disable": "关闭此设备上的加密同步吗？本地数据将保留。",
