...
export default {
  ...
  'ob.btn.start': 'Başla',
  'ob.cloud.body': 'WebBrain Cloud günlük ücretsiz tahsis ile hazır. Seçilen Cloud sohbetleri, WebBrain\'i Geliştir Yardımı varsayılan olarak açıkken WebBrain\'i geliştirmek için saklanabilir ve kullanılabilir. Bunu Ayarlar → Genel olarak kapatabilirsiniz.',
  'ob.cloud.change': 'Değiştir',
  'ob.cloud.using': 'WebBrain Cloud kullanılıyor.',
  ...
  'sp.permissions.disabled_html': '⚠️ <strong>İzin istemleri KAPALI.</strong> WebBrain, sormadan tıklayacak, yazacak, gezinecek, JavaScript çalıştıracak, dosya yükleyecek, indirecek, kayıt yapacak ve gelecek işleri zamanlayacaktır. Bunu Ayarlar → İzinler → Önemli işlemlerden önce sor ayarlarından yeniden etkinleştirin.',
  ...
  'tool.inject_css': 'CSS ekleniyor',
  'tool.remove_injected_css': 'Eklenen CSS kaldırılıyor',
  'tool.patch_element': 'Öğe yamalanıyor',
  'tool.revert_patch': 'Öğe yaması geri alınıyor',
  'tool.read_console': 'Konsol okunuyor',
  'tool.inspect_network_requests': 'Ağ istekleri inceleniyor',
  'tool.inspect_event_listeners': 'Olay dinleyicileri inceleniyor',
  'tool.highlight_element': 'Öğe vurgulanıyor',
  'tool.new_tab': 'Yeni sekme açılıyor',
  'tool.screenshot': 'Ekran görüntüsü alınıyor',
  'tool.done': 'Tamamlanıyor',
  'sp.tool.done.completed': ' tamamlandı',
  'sp.tool.done.rejected': ' tamamlandı (reddedildi)',
  'sp.tool.done.failed': ' tamamlandı (başarısız)',
  ...
  'st.display.auto_group_tabs.label': 'WebBrain sekmelerini grupla',
  'st.display.auto_group_tabs.desc': 'Araç çubuğundan, bağlam menüsünden veya aracı tarafından açılan sekmeleri otomatik olarak WebBrain adlı bir tarayıcı sekme grubuna yerleştirir. Bu ayarı kapatmak mevcut grupları değiştirmez.',
  ...
  'st.provider.field.vision_pending': 'Otomatik algılama bir sonraki isteğin öncesinde çalışır.',
  ...
  "sp.perm.verb.dev_patch": "sayfayı geçici olarak değiştirmek",
  ...
  "sp.slash.watch": "Koşul gerçekleşene kadar bu sayfayı izle",
  "sp.slash.watch_keep": "Farklı eşleşmelerden sonra izlemeye devam et",
  "sp.slash.watch_secs": "Kontrol aralığını saniye olarak ayarla",
  "sp.slash.watch_long": "Uzun izleme uyarısı kullan",
  "sp.slash.watch_short": "Kısa izleme uyarısı kullan",
  "sp.watch.created": "Bu sayfa her {seconds} saniyede izleniyor.",
  "sp.watch.exists": "Bu sayfa aynı koşulla zaten izleniyor.",
  "sp.watch.error": "İzleme oluşturulamadı: {error}",
  ...
  "st.captcha.saved": "Kaydedildi. CapSolver etkin.",
  ...
  'sp.scheduled.watch_keep': 'her eşleşmeden sonra izlemeye devam eder',
  ...
  'sp.plan.intent_unavailable': 'Planlama iki denemeden sonra başarısız oldu. Normal güvenlik kontrolleriyle Act modunda devam ediliyor.',
  ...
  'st.display.cloud_bridge.status_disabled': 'Köprü devre dışı',
  'st.display.cloud_bridge.status_connecting': 'Bağlanıyor…',
  'st.display.cloud_bridge.status_connected': 'Bağlandı',
  'st.display.cloud_bridge.status_reconnecting': 'Yeniden bağlanıyor ({attempt}. deneme)…',
  'st.display.cloud_bridge.status_error': 'Bağlantı hatası: {error}',
  'st.display.cloud_bridge.status_unreachable': '{url} adresine ulaşılamıyor. Eşleşen yerel köprü hizmetini başlatın; yeniden deneniyor…',
  ...
  'st.display.plan_before_act.desc': 'Act ve Dev modları araçlardan önce her zaman yapılandırılmış bir niyet kontrolü çalıştırır. Dene (varsayılan) ayrıca tam planlar oluşturur ancak kısa bir takipte yakın zamanda onaylanmış planı yeniden kullanabilir; Katı her turda tam plan oluşturur. Niyet veya planlama hâlâ geçersizse Dene bir kez daha dener, ardından bir uyarı gösterip Act modunda devam eder; Katı araçlardan önce durur.',
  ...
  "sp.mic.permission_denied": "Mikrofon engellendi — araç çubuğundaki WebBrain simgesine sağ tıklayın → Uzantıyı yönet → Site ayarları → Mikrofon’u İzin ver olarak ayarlayın",
  ...
  'sp.plan.step_placeholder': 'Adım eylemi',
  ...
  "sp.slash.delete_workflow": "Kayıtlı iş akışını kimliğe göre sil",
  "sp.workflows.title_html": "<strong>Kayıtlı iş akışları</strong>",
  "sp.workflows.empty": "Henüz kayıtlı iş akışı yok. İzlenen bir görevi tamamlayıp /workflow --save <name> kullanın.",
  "sp.workflows.item": "{id}  {name}  ({steps} adım, {parameters} parametre)",
  "sp.workflows.meta": "{id} · {steps} adım · {parameters} parametre",
  "sp.workflows.delete_confirm": "Silmeyi onayla",
  "sp.workflows.rename": "Yeniden adlandır",
  "sp.workflows.saved": "“{name}” iş akışı kaydedildi.",
  "sp.workflows.deleted": "“{name}” iş akışı silindi.",
  "sp.workflows.error": "İş akışı hatası: {msg}",
  "sp.teach.started": "“{name}” öğretiliyor. İş akışını tamamlayın, ardından /teach --end kullanın.",
  "sp.teach.status": "“{name}” öğretiliyor: {count} eylem yakalandı.",
  "sp.teach.inactive": "Öğretme modu etkin değil.",
  "sp.teach.saved": "“{name}” iş akışı {count} adımla öğrenildi.",
  "sp.teach.already_active": "Öğretme modu bu sekmede zaten etkin.",
  "sp.teach.agent_running": "Öğretme modunu başlatmadan önce etkin ajan çalışmasını durdurun.",
  "sp.teach.capture_unavailable": "Öğretme modu bu sayfayı yakalayamıyor. Normal bir http(s) sayfası açın veya yenileyip tekrar deneyin.",
  "sp.workflows.reason.no_trace": "Bu konuşmada başarılı ve kaydedilmiş bir çalışma bulunamadı. İzlemeyi açın, görevi tamamlayın ve kaydedin.",
  ...
  "st.imageBudget.heading": "Görüntü bütçesi",
  "st.imageBudget.desc": "Ekran görüntüsü boyutunu ve ajanın tur başına görüş için kaç kez yakalayacağını kontrol eder. Daha düşük ayrıntı ve boyut küçük uçlarda maliyet ve gecikmeyi azaltır; daha yüksek değer sadakati korur. Varsayılanlar önceki davranışla uyumludur.",
  "st.imageBudget.detail.label": "Görüntü ayrıntısı",
  "st.imageBudget.detail.desc": "Modele gönderilen görüş görüntüsü ayrıntısı. «high» daha fazla ayrıntı tutar (daha fazla token ve maliyet); «low» daha küçük ve ucuz bir görüntü gönderir; «auto» sağlayıcının karar vermesine bırakır. Sağlayıcıya bağlıdır.",
  "st.imageBudget.detail.high": "Yüksek (daha fazla ayrıntı, daha fazla maliyet)",
  "st.imageBudget.detail.low": "Düşük (daha ucuz, daha az ayrıntı)",
  "st.imageBudget.detail.auto": "Otomatik (sağlayıcı varsayılanı)",
  "st.imageBudget.maxPerTurn.label": "Tur başına en fazla ekran görüntüsü",
  "st.imageBudget.maxPerTurn.desc": "Ajanın bir turda görüş için alabileceği otomatik ekran görüntüsü sayısı (0 = sınırsız). Daha düşük değerler maliyeti azaltır; bütçe dolunca o tur için başka otomatik görüntü alınmaz.",
  "st.imageBudget.maxPerTurn.unlimited": "Sınırsız",
  ...
  'st.skills.cws.heading': 'Chrome Web Store sürüm ayarı',
  'st.skills.cws.desc_html': 'Bu ayarlar yalnızca paketlenmiş sürüm becerisi etkin olduğunda görünür. Google Cloud\'da bir OAuth Web uygulaması oluşturun, Chrome Web Store API\'yi etkinleştirin ve <code>http://localhost:1457/auth/callback</code> yetkilendirilmiş yönlendirme URI\'si olarak kaydedin. Kimlik bilgileri, belirteçler ve ZIP baytları uzantı yerel deposunda kalır ve asla model isteklerine veya izlemelere dahil edilmez.',
  'st.skills.cws.publisher_id': 'Yayıncı ID',
  'st.skills.cws.item_id': 'Öğe ID (32 karakterlik uzantı ID)',
  'st.skills.cws.oauth_client_id': 'Google OAuth istemci ID',
  'st.skills.cws.oauth_client_secret': 'Google OAuth istemci sırrı',
  'st.skills.cws.redirect_help': 'Yetkilendirilmiş yönlendirme URI: http://localhost:1457/auth/callback',
  'st.skills.cws.save': 'Ayarı kaydet',
  'st.skills.cws.connect': 'Google\'ı bağla',
  'st.skills.cws.signout': 'Bağlantıyı kes',
  'st.skills.cws.saved': 'Chrome Web Store ayarı yerel olarak kaydedildi.',
  'st.skills.cws.connected': 'Google OAuth, Chrome Web Store erişimi için bağlı.',
  'st.skills.cws.disconnected': 'Google OAuth bağlı değil.',
  'st.skills.cws.signed_out': 'Google OAuth belirteçleri kaldırıldı.',
  'st.skills.cws.connect_failed': 'Google OAuth\'a bağlanılamadı.',
  'st.skills.cws.package': 'Sürüm paketi (.zip)',
  'st.skills.cws.package_empty': 'Sürüm ZIP\'i seçilmedi.',
  'st.skills.cws.package_selected': '{name} · {size} KB · yerel olarak saklanıyor',
  'st.skills.cws.package_ready': 'Sürüm ZIP\'i güvenilir yükleme aracı için hazır.',
  'st.skills.cws.clear_package': 'Seçili ZIP\'i temizle',
  ...
  "st.sync.title": "Şifreli Bulut Senkronizasyonu",
  "st.sync.lede_html": "<strong>Yalnızca WebBrain Cloud üyeleri.</strong> Cihazlar arasında anıları, profil otomatik doldurmayı ve API anahtarı sağlayıcı ayarlarını senkronize edin. Yüklemeden önce her şey senkronizasyon şifrenizle şifrelenir. WebBrain bunu okuyamaz veya kurtaramaz. Sohbet geçmişi ve OAuth oturum açma işlemleri senkronize edilmez.",
  "st.sync.email.label": "WebBrain Bulut e-postası",
  "st.sync.password.label": "Şifreleme için şifreyi senkronize et (12+ karakter)",
  "st.sync.confirm.label": "Senkronizasyon şifresini onaylayın",
  "st.sync.action.auth": "Oturum açma bağlantısını gönder",
  "st.sync.action.enable": "Şifreli senkronizasyonu aç",
  "st.sync.action.unlock": "Şifrelenmiş senkronizasyonun kilidini açın",
  "st.sync.action.now": "Şimdi senkronize et",
  "st.sync.action.lock": "Kilit",
  "st.sync.action.change_password": "Senkronizasyon şifresini değiştir",
  "st.sync.action.disable": "Bu cihazda senkronizasyonu kapat",
  "st.sync.action.reset": "Bulut kopyasını bu cihazla değiştirin",
  "st.sync.status.syncing": "Şifreli senkronizasyon güncelleniyor…",
  "st.sync.status.offline": "Şifreli senkronizasyon bir bağlantı bekliyor.",
  "st.sync.status.subscription": "Şifreli senkronizasyon için WebBrain Cloud üyeliği gereklidir.",
  "st.sync.status.error": "Şifreli senkronizasyona dikkat edilmesi gerekiyor.",
  "st.sync.status.auth_required": "Şifreli senkronizasyonu kullanmak için WebBrain Cloud e-postanızla oturum açın.",
  "st.sync.status.password_required": "Oturum açıldı. Şifreli senkronizasyonu açmak için bir senkronizasyon şifresi seçin.",
  "st.sync.status.unlocked": "Bu cihaz için şifreli senkronizasyon açık.",
  "st.sync.status.locked": "Şifreli senkronizasyon kilitlendi. Bu cihazda kilidini açmak için senkronizasyon şifrenizi girin.",
  "st.sync.result.updated": "Şifreli senkronizasyon güncellendi.",
  "st.sync.result.current": "Şifreli senkronizasyon güncel.",
  "st.sync.pending.syncing": "Şifrelenmiş bulut kopyası senkronize ediliyor…",
  "st.sync.pending.syncing_short": "Senkronize ediliyor…",
  "st.sync.error.generic": "Şifreli senkronizasyon başarısız oldu: {error}",
  "st.sync.error.unknown": "Bilinmeyen hata",
  "st.sync.validation.email_required": "WebBrain Cloud faturalandırma e-postanızı girin.",
  "st.sync.validation.password_length": "En az 12 karakterden oluşan bir senkronizasyon şifresi kullanın.",
  "st.sync.validation.confirm_required": "Senkronizasyon şifresini onaylayın.",
  "st.sync.validation.password_mismatch": "Senkronizasyon şifreleri eşleşmiyor.",
  "st.sync.prompt.new_password": "Yeni senkronizasyon şifresi",
  "st.sync.prompt.password": "{label} (12+ karakter):",
  "st.sync.prompt.confirm_password": "Senkronizasyon şifresini onaylayın:",
  "st.sync.prompt.current_password": "Geçerli senkronizasyon şifresi:",
  "st.sync.prompt.replacement_password": "Yedek bulut kopyası için şifreyi senkronize edin",
  "st.sync.auth.check_email": "E-postanızı kontrol edin, WebBrain Cloud oturum açma bağlantısını onaylayın ve ardından buraya geri dönün.",
  "st.sync.auth.success": "Bulut Senkronizasyonu doğrulandı. Bir şifre belirleyin ve senkronizasyonu etkinleştirin.",
  "st.sync.confirm.disable": "Bu cihazda şifreli senkronizasyon kapatılsın mı? Yerel veriler kalacak.",
