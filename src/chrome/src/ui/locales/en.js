...
export default {
  ...
  'brand': 'WebBrain',
  'install.page_title': 'WebBrain installed',
  'install.installed': 'WebBrain installed',
  'install.checking': 'Checking your browser…',
  'install.ready': 'Ready',
  'install.extensions': 'Extensions',
  'install.eyebrow': 'One small setup step',
  'install.title': 'Keep WebBrain one click away',
  'install.intro': 'Your browser may hide newly installed extensions. Keep WebBrain visible so it stays easy to open.',
  'install.open_extensions.title': 'Open Extensions',
  'install.open_extensions.body': 'Open your browser’s extension controls near the address bar.',
  'install.keep_visible.title': 'Keep WebBrain visible',
  'install.keep_visible.body': 'Find WebBrain and choose the pin, show, or keep-in-toolbar option.',
  'install.open.title': 'Open it from any page',
  'install.open.body': 'Select the WebBrain icon',
  'install.open.shortcut_html': 'Or press <kbd>Alt</kbd><span>+</span><kbd>Shift</kbd><span>+</span><kbd>W</kbd> anytime.',
  'install.footer': 'This cannot be done automatically—your browser leaves toolbar choices to you.',
  'install.done': 'Got it',
  'install.browser.detected': '{browser} detected',
  'install.open_panel': 'Open Side Panel',
  'install.open_sidebar': 'Open Sidebar',
  'install.open_panel.body': 'Open WebBrain next to this page to finish setup.',
  'install.pin.title': 'Pin WebBrain to your toolbar',
  'install.pin.body': 'Click the pin in the side panel header above. This adds WebBrain to your browser toolbar for one-click access.',
  'install.pin.next': 'After the side panel opens, use the pin in its header to add WebBrain to your browser toolbar.',
  'install.pin.confirm': 'I pinned it',
  'install.pin.skip': 'Skip this step',
  ...
  'sp.record.full_screen_started_html': 'Screen/window recording started. Stop it with <strong>Stop</strong> on the recording banner, by pressing <code>Escape</code> twice in WebBrain or a browser page, or with Chrome\'s Stop sharing control. Add <code>--hide-recording-indicator</code> to keep the banner out of the video.',
  'sp.record.full_screen_started_hidden_html': 'Screen/window recording started. Press <code>Escape</code> twice in WebBrain or a browser page to stop, or use Chrome\'s Stop sharing control.',
  'sp.record.saved': 'Saved to {filename}.',
  'sp.record.saving': 'Saving recording…',
  ...
  'sp.chat.back_to_question': 'Back to question',
  ...
  'sp.input.placeholder_tip.skip_permissions': 'Prompt-free mode: /dangerously-skip-permissions',
  ...
  'sp.scheduled.watch_keep': 'keeps watching after each match',
  ...
  'sp.perm.insert_skip_command': 'Insert /dangerously-skip-permissions',
  'sp.perm.skip_hint_draft': 'Your draft is unchanged. Clear it before inserting the command.',
  ...
  'sp.perm.verb.dev_patch': 'temporarily modify the page on',
  ...
  "sp.slash.watch": "Watch this page for a condition",
  "sp.slash.watch_keep": "Continue watching after distinct matches",
  "sp.slash.watch_secs": "Set the polling interval in seconds",
  "sp.slash.watch_long": "Use a long watch alert",
  "sp.slash.watch_short": "Use a short watch alert",
  "sp.watch.created": "Watching this page every {seconds} seconds.",
  ...
  'sp.screenshot.save_as': 'Save as…',
  'sp.screenshot.saving': 'Opening…',
  'sp.screenshot.save_failed': 'Could not save screenshot: {msg}',
  ...
  'sp.workflows.title_html': '<strong>Saved workflows</strong>',
  'sp.workflows.empty': 'No saved workflows yet. Complete a traced task, then use /workflow --save <name>.',
  'sp.workflows.item': '{id}  {name}  ({steps} steps, {parameters} parameters)',
  "sp.workflows.meta": "{id} · {steps} steps · {parameters} parameters",
  "sp.workflows.delete_confirm": "Confirm delete",
  "sp.workflows.rename": "Rename",
  'sp.workflows.saved': 'Saved workflow “{name}”.',
  'sp.workflows.deleted': 'Deleted workflow “{name}”.',
  'sp.workflows.error': 'Workflow error: {msg}',
  "sp.teach.started": "Teaching “{name}”. Perform the workflow, then use /teach --end.",
  "sp.teach.status": "Teaching “{name}”: {count} actions captured.",
  "sp.teach.inactive": "Teacher mode is not active.",
  "sp.teach.saved": "Learned workflow “{name}” with {count} steps.",
  "sp.teach.already_active": "Teacher mode is already active in this tab.",
  "sp.teach.agent_running": "Stop the active agent run before starting Teacher mode.",
  "sp.teach.capture_unavailable": "Teacher mode cannot capture this page. Open or reload a regular http(s) page and try again.",
  ...
  'tool.patch_element': 'Patching element',
  'tool.revert_patch': 'Reverting element patch',
  'tool.wait_for_element': 'Waiting for element',
  'tool.get_selection': 'Reading selection',
  'tool.execute_js': 'Running script',
  'tool.read_console': 'Reading console',
  'tool.inspect_network_requests': 'Inspecting network requests',
  'tool.inspect_event_listeners': 'Inspecting event listeners',
  'tool.highlight_element': 'Highlighting element',
  ...
  'ob.act.permissions_tip': 'Permission prompts are on by default. Advanced users can disable them globally with /dangerously-skip-permissions and re-enable them in Settings → Permissions.',
  ...
  'st.display.download_directory.label': 'Download directory',
  'st.display.download_directory.desc': 'Optional subfolder inside your browser or system Downloads directory. Leave blank to use the system default.',
  'st.display.download_directory.placeholder': 'System default',
  'st.display.download_directory.error': 'Use a relative folder such as WebBrain or Work/WebBrain. Absolute paths and “..” are not allowed.',
  ...
  'st.providers.api_key_warning': 'Saved, but it won’t work without a valid key. Click Test Connection and make sure you see the green success message.',
  ...
  'st.providers.ollama_warning.title': 'Why does Ollama on localhost return 403?',
  'st.providers.ollama_warning.body': 'Recent Ollama versions can reject requests from browser-extension origins even when Ollama is running on the same machine. WebBrain sends a chrome-extension://… or moz-extension://… Origin, and Ollama may return 403 unless those origins are allowed.',
  'st.providers.ollama_warning.restart': 'Quit any Ollama desktop app already holding port 11434, then start Ollama with this command:',
  'st.providers.ollama_warning.base_url': 'Keep WebBrain’s Ollama base URL set to http://localhost:11434/v1. Terminal curl checks can still work without this setting because they do not send a browser-extension origin.',
  'st.providers.ollama_warning.link': 'Read the Ollama launch handoff',
  ...
  'st.provider.field.vision_pending': 'Auto-detection runs before the next request.',
  ...
  'st.imageBudget.maxPerTurn.label': 'Max model-facing screenshots per turn',
  'st.imageBudget.maxPerTurn.desc': 'How many model-facing auto-screenshots the agent may capture for vision within a single turn (0 = unlimited). Lower values reduce cost; once this budget is spent further model-facing auto-screenshots are skipped. With a finite limit, the first rich-text toolbar safety check may use one separate capture, so the turn takes at most the configured limit plus one.',
  ...
  'st.captcha.saved': 'Saved. CapSolver is enabled.',
  'st.captcha.cleared': 'Cleared.',
  'st.captcha.checking': 'Checking balance…',
  'st.captcha.need_key': 'Enter a valid CapSolver API key beginning with CAP-.',
  ...
  'st.providers.webgpu_note.body': '{modelLink} runs entirely in Chrome with no API endpoint. Download it in Apocalypse Mode, then use the nuclear control in standalone chat.',
  'st.providers.webgpu_note.managed_body': '{modelLink} runs entirely in Chrome with no API endpoint. Download it in Apocalypse Mode, then use the nuclear control in standalone chat. It does not replace your selected provider.',
