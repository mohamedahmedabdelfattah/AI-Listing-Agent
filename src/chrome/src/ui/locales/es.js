...
export default {
  ...
  'ob.cloud.body': 'WebBrain Cloud está listo con una asignación diaria gratuita. Las conversaciones de Cloud seleccionadas pueden conservarse y utilizarse para mejorar WebBrain mientras Ayuda a mejorar WebBrain está activado de forma predeterminada. Puedes desactivarlo en Configuración → General.',
  ...
  'tool.inject_css': 'Inyectando CSS',
  'tool.remove_injected_css': 'Eliminando CSS inyectado',
  'tool.patch_element': 'Modificando elemento',
  'tool.revert_patch': 'Revirtiendo modificación',
  'tool.read_console': 'Leyendo la consola',
  'tool.inspect_network_requests': 'Inspeccionando solicitudes de red',
  'tool.inspect_event_listeners': 'Inspeccionando eventos',
  'tool.highlight_element': 'Resaltando elemento',
  ...
  'st.vision.local.title': 'Alternativa local LFM2.5-VL',
  'st.vision.local.desc': 'Ejecuta LiquidAI/LFM2.5-VL-450M-ONNX en tu GPU. Las capturas de pantalla permanecen en este dispositivo; la primera vez se descargan unos 770 MB de Hugging Face en segundo plano y se guardan en la caché local. Puedes cambiar de pestaña o cerrar Configuración durante la descarga; mantén Chrome abierto.',
  'st.vision.local.enable': 'Usar alternativa local',
  'st.vision.local.disable': 'Desactivar alternativa local',
  'st.vision.local.saved': 'Alternativa local de visión activada.',
  'st.vision.local.testing': 'Cargando y probando la visión local… La primera vez se descargan unos 770 MB en segundo plano. Puedes cambiar de pestaña o cerrar Configuración; mantén Chrome abierto.',
  ...
  "sp.perm.verb.dev_patch": "modificar temporalmente la página en",
  ...
  "sp.slash.watch": "Vigilar esta página hasta que se cumpla una condición",
  "sp.slash.watch_keep": "Seguir vigilando después de coincidencias distintas",
  "sp.slash.watch_secs": "Definir el intervalo de comprobación en segundos",
  "sp.slash.watch_long": "Usar una alerta de vigilancia larga",
  "sp.slash.watch_short": "Usar una alerta de vigilancia corta",
  "sp.watch.created": "Vigilando esta página cada {seconds} segundos.",
  "sp.watch.exists": "Esta página ya se está vigilando con la misma condición.",
  "sp.watch.error": "No se pudo crear la vigilancia: {error}",
  ...
  "st.captcha.saved": "Guardado. CapSolver está activado.",
  ...
  'sp.scheduled.watch_keep': 'sigue vigilando tras cada coincidencia',
  ...
  'sp.plan.timed_out': 'Se agotó el tiempo para aprobar',
  'sp.plan.timed_out_hint': 'No se ejecutó nada. Vuelve a intentarlo para revisar un plan nuevo.',
  'sp.plan.awaiting_review': 'Aprueba o cancela el plan anterior antes de enviar otro mensaje.',
  'sp.plan.intent_unavailable': "La planificación falló tras dos intentos. Se continúa en modo Act con las protecciones habituales.",
  ...
  'st.display.cloud_bridge.label': 'Puente en la nube',
  'st.display.cloud_bridge.desc': 'Conecta un controlador local a este perfil de Chromium. Usa el puerto 17373 para WebBrain Cloud, 17374 para clientes MCP o 17375 para LM Studio. Solo puede haber un puente activo; los avisos de permisos siguen aplicándose.',
  'st.display.cloud_bridge.url_label': 'URL de WebSocket',
  'st.display.cloud_bridge.url_placeholder': 'ws://127.0.0.1:17373/extension',
  'st.display.cloud_bridge.invalid_url': 'Usa una URL ws:// local con 127.0.0.1, localhost o ::1.',
  'st.display.cloud_bridge.status_disabled': 'Puente desactivado',
  'st.display.cloud_bridge.status_connecting': 'Conectando…',
  'st.display.cloud_bridge.status_connected': 'Conectado',
  'st.display.cloud_bridge.status_reconnecting': 'Reconectando (intento {attempt})…',
  'st.display.cloud_bridge.status_error': 'Error de conexión: {error}',
  'st.display.cloud_bridge.status_unreachable': 'No se puede acceder a {url}. Inicia el servicio de puente local correspondiente; reintentando…',
  ...
  'st.display.plan_before_act.desc': "Los modos Act y Dev siempre ejecutan una comprobación estructurada de intención antes de usar herramientas. Intentar (predeterminado) también crea planes completos, pero puede reutilizar uno aprobado recientemente para un seguimiento breve; Estricto crea un plan completo en cada turno. Intentar vuelve a probar una vez y, si la intención o el plan siguen siendo inválidos, continúa en modo Act con una advertencia; Estricto se detiene antes de usar herramientas.",
  ...
  "st.display.webmcp.desc": "Permite que WebBrain descubra y ejecute herramientas estructuradas expuestas por páginas de Chrome compatibles. Al activarlo, se añaden herramientas WebMCP experimentales y sus indicaciones al contexto del modelo. Desactivado por defecto.",
  ...
  "sp.mic.permission_denied": "Micrófono bloqueado — haz clic derecho en el icono de WebBrain en la barra de herramientas → Gestionar extensión → Configuración del sitio → establece Micrófono en Permitir",
  ...
  "sp.slash.delete_workflow": "Eliminar un flujo de trabajo guardado por ID",
  "sp.workflows.title_html": "<strong>Flujos de trabajo guardados</strong>",
  "sp.workflows.empty": "Aún no hay flujos guardados. Completa una tarea con seguimiento y usa /workflow --save <name>.",
  "sp.workflows.item": "{id}  {name}  ({steps} pasos, {parameters} parámetros)",
  "sp.workflows.meta": "{id} · {steps} pasos · {parameters} parámetros",
  "sp.workflows.delete_confirm": "Confirmar eliminación",
  "sp.workflows.rename": "Renombrar",
  "sp.workflows.saved": "Flujo de trabajo «{name}» guardado.",
  "sp.workflows.deleted": "Flujo de trabajo «{name}» eliminado.",
  "sp.workflows.error": "Error del flujo de trabajo: {msg}",
  "sp.teach.started": "Enseñando “{name}”. Completa el flujo y usa /teach --end.",
  "sp.teach.status": "Enseñando “{name}”: {count} acciones capturadas.",
  "sp.teach.inactive": "El modo de enseñanza no está activo.",
  "sp.teach.saved": "Se aprendió el flujo “{name}” con {count} pasos.",
  "sp.teach.already_active": "El modo de enseñanza ya está activo en esta pestaña.",
  "sp.teach.agent_running": "Detén la ejecución activa del agente antes de iniciar el modo de enseñanza.",
  "sp.teach.capture_unavailable": "El modo de enseñanza no puede capturar esta página. Abre o recarga una página http(s) normal e inténtalo de nuevo.",
  "sp.workflows.reason.no_trace": "No se encontró una ejecución registrada y correcta en esta conversación. Activa el seguimiento, completa la tarea y guárdala.",
  ...
  "st.sync.title": "Sincronización encriptada en la nube",
  "st.sync.lede_html": "<strong>Solo miembros de WebBrain Cloud.</strong> Sincronice memorias, autocompletar perfiles y configuraciones del proveedor de claves API en todos los dispositivos. Todo está cifrado con su contraseña de sincronización antes de cargarlo. WebBrain no puede leerlo ni recuperarlo. El historial de chat y los inicios de sesión de OAuth no están sincronizados.",
  "st.sync.email.label": "Correo electrónico en la nube de WebBrain",
  "st.sync.password.label": "Contraseña de sincronización para cifrado (más de 12 caracteres)",
  "st.sync.confirm.label": "Confirmar contraseña de sincronización",
  "st.sync.action.auth": "Enviar enlace de inicio de sesión",
  "st.sync.action.enable": "Activar la sincronización cifrada",
  "st.sync.action.unlock": "Desbloquear sincronización cifrada",
  "st.sync.action.now": "Sincronizar ahora",
  "st.sync.action.lock": "Bloquear",
  "st.sync.action.change_password": "Cambiar contraseña de sincronización",
  "st.sync.action.disable": "Desactivar la sincronización en este dispositivo",
  "st.sync.action.reset": "Reemplace la copia en la nube con este dispositivo",
  "st.sync.status.syncing": "La sincronización cifrada se está actualizando...",
  "st.sync.status.offline": "La sincronización cifrada está esperando una conexión.",
  "st.sync.status.subscription": "Se requiere membresía de WebBrain Cloud para la sincronización cifrada.",
  "st.sync.status.error": "La sincronización cifrada necesita atención.",
  "st.sync.status.auth_required": "Inicie sesión con su correo electrónico de WebBrain Cloud para utilizar la sincronización cifrada.",
  "st.sync.status.password_required": "Ha iniciado sesión. Elija una contraseña de sincronización para activar la sincronización cifrada.",
  "st.sync.status.unlocked": "La sincronización cifrada está activada para este dispositivo.",
  "st.sync.status.locked": "La sincronización cifrada está bloqueada. Ingrese su contraseña de sincronización para desbloquearla en este dispositivo.",
  "st.sync.result.updated": "Sincronización cifrada actualizada.",
  "st.sync.result.current": "La sincronización cifrada está actualizada.",
  "st.sync.pending.syncing": "Sincronizando copia cifrada en la nube...",
  "st.sync.pending.syncing_short": "Sincronizando…",
  "st.sync.error.generic": "Error de sincronización cifrada: {error}",
  "st.sync.error.unknown": "Error desconocido",
  "st.sync.validation.email_required": "Ingrese su correo electrónico de facturación de WebBrain Cloud.",
  "st.sync.validation.password_length": "Utilice una contraseña de sincronización de al menos 12 caracteres.",
  "st.sync.validation.confirm_required": "Confirme la contraseña de sincronización.",
  "st.sync.validation.password_mismatch": "Las contraseñas de sincronización no coinciden.",
  "st.sync.prompt.new_password": "Nueva contraseña de sincronización",
  "st.sync.prompt.password": "{label} (más de 12 caracteres):",
  "st.sync.prompt.confirm_password": "Confirmar contraseña de sincronización:",
  "st.sync.prompt.current_password": "Contraseña de sincronización actual:",
  "st.sync.prompt.replacement_password": "Contraseña de sincronización para la copia en la nube de reemplazo",
  "st.sync.auth.check_email": "Revise su correo electrónico, apruebe el enlace de inicio de sesión de WebBrain Cloud y luego regrese aquí.",
  "st.sync.auth.success": "Sincronización en la nube autenticada. Establezca una contraseña y habilite la sincronización.",
  "st.sync.confirm.disable": "¿Desactivar la sincronización cifrada en este dispositivo? Los datos locales permanecerán.",
