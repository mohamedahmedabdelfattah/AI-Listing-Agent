...
export default {
  ...
  'install.installed': 'Naka-install na ang WebBrain',
  'install.checking': 'Sinusuri ang iyong browser…',
  'install.ready': 'Handa na',
  'install.extensions': 'Mga extension',
  'install.eyebrow': 'Isang maliit na hakbang sa pag-set up',
  'install.title': 'Panatilihing isang click lang ang WebBrain',
  'install.intro': 'Maaaring itago ng browser ang mga bagong extension. Panatilihing nakikita ang WebBrain para madali itong buksan.',
  'install.open_extensions.title': 'Buksan ang mga extension',
  'install.open_extensions.body': 'Buksan ang mga kontrol ng extension malapit sa address bar.',
  'install.keep_visible.title': 'Panatilihing nakikita ang WebBrain',
  'install.keep_visible.body': 'Hanapin ang WebBrain at piliing i-pin, ipakita, o panatilihin ito sa toolbar.',
  'install.open.title': 'Buksan mula sa anumang page',
  'install.open.body': 'Piliin ang icon ng WebBrain',
  'install.open.shortcut_html': 'O pindutin ang <kbd>Alt</kbd><span>+</span><kbd>Shift</kbd><span>+</span><kbd>W</kbd> anumang oras.',
  'install.footer': 'Hindi ito awtomatikong magagawa—ikaw ang pinapapili ng browser kung ano ang lalabas sa toolbar.',
  'install.done': 'Nakuha ko',
  'install.browser.detected': 'Natukoy ang {browser}',
  'install.open_panel': 'Buksan ang Side Panel',
  'install.open_sidebar': 'Buksan ang Sidebar',
  'install.open_panel.body': 'Buksan ang WebBrain sa tabi ng pahinang ito para matapos ang setup.',
  'install.pin.title': 'I-pin ang WebBrain sa toolbar',
  'install.pin.body': 'I-click ang pin sa header ng side panel sa itaas. Idaragdag nito ang WebBrain sa browser toolbar para mabuksan sa isang click.',
  'install.pin.next': 'Kapag nakabukas na ang side panel, gamitin ang pin sa header nito para idagdag ang WebBrain sa browser toolbar.',
  'install.pin.confirm': 'Na-pin ko na',
  'install.pin.skip': 'Laktawan ang hakbang na ito',
  ...
  'ob.cloud.body': 'Ang WebBrain Cloud ay handa na may libreng araw-aldaw na alokasyon. Maaaring manatili at gamitin ang mga napiling Cloud na pakikipag-usap upang mapahusay ang WebBrain habang ang Tulong sa Pagsasapa ng WebBrain ay naka-on sa default. Maaari mong ito sa Settings → General.',
  'ob.cloud.change': 'Baguhin',
  'ob.cloud.using': 'Gumagamit ng WebBrain Cloud.',
  ...
  'tool.done': 'Tinatapos',
  'sp.tool.done.completed': ' tapos na',
  'sp.tool.done.rejected': ' tapos na (tinanggihan)',
  'sp.tool.done.failed': ' tapos na (nabigo)',
  ...
  "sp.record.saved": "Na-save sa {filename}.",
  "sp.record.saving": "Sine-save ang recording…",
  ...
  "sp.slash.watch": "Bantayan ang pahinang ito hanggang matupad ang kundisyon",
  "sp.slash.watch_keep": "Magpatuloy pagkatapos ng magkakaibang pagtutugma",
  "sp.slash.watch_secs": "Itakda ang pagitan ng pagsusuri sa segundo",
  "sp.slash.watch_long": "Gumamit ng mahabang alerto sa pagbabantay",
  "sp.slash.watch_short": "Gumamit ng maikling alerto sa pagbabantay",
  "sp.watch.created": "Binabantayan ang pahinang ito bawat {seconds} segundo.",
  "sp.watch.exists": "Binabantayan na ang pahinang ito gamit ang parehong kundisyon.",
  "sp.watch.error": "Hindi magawa ang pagbabantay: {error}",
  ...
  "sp.screenshot.save_as": "I-save bilang…",
  "sp.screenshot.saving": "Binubuksan…",
  "sp.screenshot.save_failed": "Hindi ma-save ang screenshot: {msg}",
  ...
  "st.display.download_directory.label": "Direktoryo ng download",
  "st.display.download_directory.desc": "Opsyonal na subfolder sa loob ng Downloads directory ng browser o system. Iwang blangko upang gamitin ang default ng system.",
  ...
  "st.providers.api_key_warning": "Na-save, pero hindi ito gagana nang walang wastong key. I-click ang Test Connection at tiyaking makikita ang berdeng mensahe ng tagumpay.",
  "st.providers.ollama_warning.label": "FAQ ng Ollama",
  "st.providers.ollama_warning.title": "Bakit nagbabalik ng 403 ang Ollama sa localhost?",
  "st.providers.ollama_warning.body": "Maaaring tanggihan ng mga bagong bersyon ng Ollama ang mga request mula sa origin ng browser extension kahit tumatakbo ang Ollama sa parehong computer. Nagpapadala ang WebBrain ng Origin tulad ng chrome-extension://… o moz-extension://…, at maaaring magbalik ang Ollama ng 403 kung hindi pinapayagan ang mga origin na iyon.",
  "st.providers.ollama_warning.restart": "Isara ang anumang Ollama desktop app na gumagamit na ng port 11434, pagkatapos ay simulan ang Ollama gamit ang command na ito:",
  "st.providers.ollama_warning.base_url": "Panatilihing http://localhost:11434/v1 ang Ollama base URL ng WebBrain. Maaaring gumana ang mga curl test sa terminal nang wala ang setting na ito dahil hindi sila nagpapadala ng origin ng browser extension.",
  "st.providers.ollama_warning.link": "Basahin ang anunsyo ng integrasyon ng Ollama",
  ...
  "st.captcha.saved": "Na-save. Naka-enable ang CapSolver.",
  ...
  'sp.scheduled.watch_keep': 'patuloy na nagbabantay pagkatapos ng bawat tugma',
  ...
  'st.display.cloud_bridge.invalid_url': 'Gumamit ng lokal na ws:// URL na may 127.0.0.1, localhost, o ::1.',
  'st.display.cloud_bridge.status_disabled': 'Naka-disable ang bridge',
  'st.display.cloud_bridge.status_connecting': 'Kumokonekta…',
  'st.display.cloud_bridge.status_connected': 'Konektado',
  'st.display.cloud_bridge.status_reconnecting': 'Kumokonekta muli (pagsubok {attempt})…',
  'st.display.cloud_bridge.status_error': 'Error sa koneksyon: {error}',
  'st.display.cloud_bridge.status_unreachable': 'Hindi maabot ang {url}. Simulan ang katugmang lokal na bridge service; sinusubukang muli…',
  ...
  'st.display.plan_before_act.desc': "Palaging nagsasagawa ang Act at Dev mode ng nakaayos na pagsusuri ng layunin bago gumamit ng mga tool. Gumagawa rin ng buong plano ang Subukan (default), ngunit maaari nitong gamitin muli ang kamakailang inaprubahang plano para sa maikling follow-up; gumagawa ng buong plano ang Mahigpit sa bawat turno. Susubok muli nang isang beses ang Subukan at magpapatuloy sa Act mode na may babala kung hindi pa rin valid ang layunin o plano; hihinto ang Mahigpit bago gumamit ng mga tool.",
  ...
  'sp.plan.step_placeholder': 'Aksyon ng hakbang',
  ...
  "sp.slash.delete_workflow": "Tanggalin ang naka-save na workflow ayon sa ID",
  "sp.workflows.title_html": "<strong>Mga naka-save na workflow</strong>",
  "sp.workflows.empty": "Wala pang naka-save na workflow. Tapusin ang isang naka-trace na gawain, saka gamitin ang /workflow --save <name>.",
  "sp.workflows.item": "{id}  {name}  ({steps} hakbang, {parameters} parameter)",
  "sp.workflows.meta": "{id} · {steps} hakbang · {parameters} parameter",
  "sp.workflows.delete_confirm": "Kumpirmahin ang pagbura",
  "sp.workflows.rename": "Palitan ang pangalan",
  "sp.workflows.saved": "Na-save ang workflow na “{name}”.",
  "sp.workflows.deleted": "Tinanggal ang workflow na “{name}”.",
  "sp.workflows.error": "Error sa workflow: {msg}",
  "sp.teach.started": "Itinuturo ang “{name}”. Gawin ang workflow, pagkatapos ay gamitin ang /teach --end.",
  "sp.teach.status": "Itinuturo ang “{name}”: {count} kilos ang nakuha.",
  "sp.teach.inactive": "Hindi aktibo ang teacher mode.",
  "sp.teach.saved": "Natutunan ang workflow na “{name}” na may {count} hakbang.",
  "sp.teach.already_active": "Aktibo na ang teacher mode sa tab na ito.",
  "sp.teach.agent_running": "Itigil ang aktibong agent run bago simulan ang teacher mode.",
  "sp.teach.capture_unavailable": "Hindi makuha ng teacher mode ang pahinang ito. Magbukas o mag-reload ng karaniwang http(s) page at subukan muli.",
  "sp.workflows.reason.no_trace": "Walang matagumpay na naitalang run sa usapang ito. I-on ang tracing, tapusin ang gawain, at i-save ito.",
  ...
  "st.imageBudget.heading": "Badyet ng imahe",
  "st.imageBudget.desc": "Kontrolin ang laki ng screenshot at kung ilang beses kumuha ang agent para sa vision bawat turn. Mas mababang detalye at sukat ay nagpapababa ng gastos at latency sa maliliit na endpoint; mas mataas ay nagpapanatili ng fidelity. Ang default ay tumutugma sa dating gawi.",
  "st.imageBudget.detail.label": "Detalye ng imahe",
  "st.imageBudget.detail.desc": "Detalye ng vision image na ipinapadala sa modelo. «high» ay mas maraming detalye (mas maraming token at gastos); «low» ay mas maliit at murang imahe; «auto» ay desisyon ng provider. Depende sa provider.",
  "st.imageBudget.detail.high": "Mataas (mas detalye, mas gastos)",
  "st.imageBudget.detail.low": "Mababa (mas mura, mas kaunting detalye)",
  "st.imageBudget.detail.auto": "Auto (default ng provider)",
  "st.imageBudget.maxPerTurn.label": "Max na screenshot bawat turn",
  "st.imageBudget.maxPerTurn.desc": "Ilang auto-screenshot ang maaaring kunin ng agent para sa vision sa isang turn (0 = walang limit). Mas mababang halaga ay nagpapababa ng gastos; kapag naubos ang badyet, lalaktawan ang susunod na auto-screenshot sa turn na iyon.",
  "st.imageBudget.maxPerTurn.unlimited": "Walang limit",
  ...
  'st.skills.cws.desc_html': 'Ang mga setting na ito ay lalabas lamang habang naka-enable ang packaged release skill. Gumawa ng Google Cloud OAuth Web application, i-enable ang Chrome Web Store API, at mag-register ng <code>http://localhost:1457/auth/callback</code> bilang authorized redirect URI. Ang mga kredensyal, token, at ZIP bytes ay nananatili sa extension-local storage at hindi kailanman isasama sa mga kahilingan ng modelo o trace.',
  ...
  'st.skills.cws.save': 'I-save ang setup',
  'st.skills.cws.connect': 'I-connect ang Google',
  'st.skills.cws.signout': 'I-disconnect',
  'st.skills.cws.saved': 'Na-save ang Chrome Web Store setup nang locale.',
  'st.skills.cws.connected': 'Naka-connect ang Google OAuth para sa Chrome Web Store access.',
  'st.skills.cws.disconnected': 'Hindi naka-connect ang Google OAuth.',
  'st.skills.cws.signed_out': 'Na-remove ang mga Google OAuth token.',
  'st.skills.cws.connect_failed': 'Hindi ma-connect ang Google OAuth.',
  'st.skills.cws.package': 'Release package (.zip)',
  'st.skills.cws.package_empty': 'Walang napiling release ZIP.',
  'st.skills.cws.package_selected': '{name} · {size} KB · naka-store locally',
  'st.skills.cws.package_ready': 'Handa na ang release ZIP para sa trusted upload tool.',
  'st.skills.cws.clear_package': 'I-clear ang napiling ZIP',
  ...
  "st.sync.title": "Naka-encrypt na Cloud Sync",
  "st.sync.lede_html": "<strong>Mga miyembro lang ng WebBrain Cloud.</strong> I-sync ang mga memory, autofill ng profile, at mga setting ng provider ng API-key sa mga device. Ang lahat ay naka-encrypt gamit ang iyong password sa pag-sync bago mag-upload. Hindi ito mabasa o mabawi ng WebBrain. Hindi naka-sync ang history ng chat at OAuth sign-in.",
  "st.sync.email.label": "Email sa WebBrain Cloud",
  "st.sync.password.label": "I-sync ang password para sa pag-encrypt (12+ character)",
  "st.sync.confirm.label": "Kumpirmahin ang password sa pag-sync",
  "st.sync.action.auth": "Magpadala ng link sa pag-sign in",
  "st.sync.action.enable": "I-on ang naka-encrypt na pag-sync",
  "st.sync.action.unlock": "I-unlock ang naka-encrypt na pag-sync",
  "st.sync.action.now": "I-sync ngayon",
  "st.sync.action.lock": "I-lock",
  "st.sync.action.change_password": "Baguhin ang password sa pag-sync",
  "st.sync.action.disable": "I-off ang pag-sync sa device na ito",
  "st.sync.action.reset": "Palitan ang cloud copy ng device na ito",
  "st.sync.status.syncing": "Ina-update ang naka-encrypt na pag-sync…",
  "st.sync.status.offline": "Ang naka-encrypt na pag-sync ay naghihintay para sa isang koneksyon.",
  "st.sync.status.subscription": "Kinakailangan ang membership sa WebBrain Cloud para sa naka-encrypt na pag-sync.",
  "st.sync.status.error": "Ang naka-encrypt na pag-sync ay nangangailangan ng pansin.",
  "st.sync.status.auth_required": "Mag-sign in gamit ang iyong WebBrain Cloud email upang magamit ang naka-encrypt na pag-sync.",
  "st.sync.status.password_required": "Naka-sign in. Pumili ng password sa pag-sync para i-on ang naka-encrypt na pag-sync.",
  "st.sync.status.unlocked": "Naka-on ang naka-encrypt na pag-sync para sa device na ito.",
  "st.sync.status.locked": "Naka-lock ang naka-encrypt na pag-sync. Ilagay ang iyong password sa pag-sync upang i-unlock ito sa device na ito.",
  "st.sync.result.updated": "Na-update ang naka-encrypt na pag-sync.",
  "st.sync.result.current": "Napapanahon ang naka-encrypt na pag-sync.",
  "st.sync.pending.syncing": "Sini-sync ang naka-encrypt na cloud copy...",
  "st.sync.pending.syncing_short": "Sini-sync…",
  "st.sync.error.generic": "Nabigo ang naka-encrypt na pag-sync: {error}",
  "st.sync.error.unknown": "Hindi kilalang error",
  "st.sync.validation.email_required": "Ilagay ang iyong email sa pagsingil sa WebBrain Cloud.",
  "st.sync.validation.password_length": "Gumamit ng password sa pag-sync ng hindi bababa sa 12 character.",
  "st.sync.validation.confirm_required": "Kumpirmahin ang password sa pag-sync.",
  "st.sync.validation.password_mismatch": "Hindi tugma ang mga password sa pag-sync.",
  "st.sync.prompt.new_password": "Bagong password sa pag-sync",
  "st.sync.prompt.password": "{label} (12+ character):",
  "st.sync.prompt.confirm_password": "Kumpirmahin ang password sa pag-sync:",
  "st.sync.prompt.current_password": "Kasalukuyang password sa pag-sync:",
  "st.sync.prompt.replacement_password": "I-sync ang password para sa kapalit na kopya ng cloud",
  "st.sync.auth.check_email": "Tingnan ang iyong email, aprubahan ang link sa pag-sign in sa WebBrain Cloud, pagkatapos ay bumalik dito.",
  "st.sync.auth.success": "Na-authenticate ang Cloud Sync. Magtakda ng password at paganahin ang pag-sync.",
  "st.sync.confirm.disable": "I-off ang naka-encrypt na pag-sync sa device na ito? Mananatili ang lokal na data.",
