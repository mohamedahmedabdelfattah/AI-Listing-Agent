...
export default {
  ...
  'ob.btn.start': 'بدء',
  'ob.cloud.body': 'WebBrain Cloud جاهز مع بدل يومي مجاني. قد يتم الاحتفاظ بمحادثات Cloud المحددة واستخدامها لتحسين WebBrain بينما يكون Help Improve WebBrain قيد التشغيل افتراضيًا. يمكنك إيقاف تشغيله في الإعدادات → عام.',
  'ob.cloud.change': 'تغيير',
  'ob.cloud.using': 'استخدام WebBrain Cloud.',
  ...
  'st.display.auto_group_tabs.label': 'تجميع علامات تبويب WebBrain',
  'st.display.auto_group_tabs.desc': 'ضع تلقائيًا علامات التبويب المفتوحة من شريط الأدوات أو قائمة السياق أو بواسطة الوكيل في مجموعة علامات تبويب متصفح باسم WebBrain. لن يؤدي إيقاف هذا الخيار إلى تغيير المجموعات الحالية.',
  ...
  'st.vision.local.desc': 'يشغّل LiquidAI/LFM2.5-VL-450M-ONNX على معالج الرسومات لديك. تبقى لقطات الشاشة على هذا الجهاز؛ عند الاستخدام الأول، يتم تنزيل نحو 770 ميغابايت من Hugging Face في الخلفية وتخزينها مؤقتًا محليًا. يمكنك تبديل علامات التبويب أو إغلاق الإعدادات أثناء التنزيل؛ أبقِ Chrome مفتوحًا.',
  ...
  'st.vision.local.testing': 'جارٍ تحميل الرؤية المحلية واختبارها… عند الاستخدام الأول، يتم تنزيل نحو 770 ميغابايت في الخلفية. يمكنك تبديل علامات التبويب أو إغلاق الإعدادات؛ أبقِ Chrome مفتوحًا.',
  ...
  "sp.slash.watch": "راقب هذه الصفحة بحثًا عن شرط",
  "sp.slash.watch_keep": "استمر في المراقبة بعد التطابقات المختلفة",
  "sp.slash.watch_secs": "اضبط فاصل التحقق بالثواني",
  "sp.slash.watch_long": "استخدم تنبيه مراقبة طويلًا",
  "sp.slash.watch_short": "استخدم تنبيه مراقبة قصيرًا",
  "sp.watch.created": "تتم مراقبة هذه الصفحة كل {seconds} ثانية.",
  "sp.watch.exists": "تُراقَب هذه الصفحة بالفعل بالشرط نفسه.",
  "sp.watch.error": "تعذر إنشاء المراقبة: {error}",
  ...
  'sp.scheduled.watch_keep': 'يواصل المراقبة بعد كل تطابق',
  ...
  'st.display.cloud_bridge.status_connected': 'متصل',
  'st.display.cloud_bridge.status_reconnecting': 'إعادة الاتصال (المحاولة {attempt})…',
  'st.display.cloud_bridge.status_error': 'خطأ في الاتصال: {error}',
  'st.display.cloud_bridge.status_unreachable': 'تعذر الوصول إلى {url}. شغّل خدمة الجسر المحلية المطابقة؛ ستتم إعادة المحاولة…',
  ...
  'st.display.plan_before_act.desc': "يجري وضعا Act وDev دائمًا فحصًا منظمًا للنية قبل تشغيل الأدوات. وضع المحاولة (الافتراضي) ينشئ أيضًا خططًا كاملة، وقد يعيد استخدام خطة معتمدة حديثًا لمتابعة قصيرة؛ والوضع الصارم ينشئ خطة كاملة في كل دورة. يعيد وضع المحاولة المحاولة مرة واحدة، ثم يتابع في وضع Act مع تحذير إذا ظل القصد أو التخطيط غير صالح؛ ويتوقف الوضع الصارم قبل تشغيل الأدوات.",
  ...
  "sp.slash.delete_workflow": "حذف مهمة سير عمل محفوظة حسب المعرّف",
  "sp.workflows.title_html": "<strong>مهام سير العمل المحفوظة</strong>",
  "sp.workflows.empty": "لا توجد مهام سير عمل محفوظة بعد. أكمل مهمة مع تفعيل التتبع، ثم استخدم /workflow --save <name>.",
  "sp.workflows.item": "{id}  {name}  ({steps} خطوات، {parameters} معلمات)",
  "sp.workflows.meta": "{id} · {steps} خطوات · {parameters} معلمات",
  "sp.workflows.delete_confirm": "تأكيد الحذف",
  "sp.workflows.rename": "إعادة التسمية",
  "sp.workflows.saved": "تم حفظ مهمة سير العمل «{name}».",
  "sp.workflows.deleted": "تم حذف مهمة سير العمل «{name}».",
  "sp.workflows.error": "خطأ في مهمة سير العمل: {msg}",
  "sp.teach.started": "جارٍ تعليم “{name}”. نفّذ مسار العمل، ثم استخدم /teach --end.",
  "sp.teach.status": "جارٍ تعليم “{name}”: تم التقاط {count} من الإجراءات.",
  "sp.teach.inactive": "وضع التعليم غير نشط.",
  "sp.teach.saved": "تم تعلم مسار العمل “{name}” في {count} من الخطوات.",
  "sp.teach.already_active": "وضع التعليم نشط بالفعل في علامة التبويب هذه.",
  "sp.teach.agent_running": "أوقف تشغيل الوكيل النشط قبل بدء وضع التعليم.",
  "sp.teach.capture_unavailable": "لا يمكن لوضع التعليم التقاط هذه الصفحة. افتح أو أعد تحميل صفحة http(s) عادية وحاول مرة أخرى.",
  "sp.workflows.reason.no_trace": "لم يتم العثور على تشغيل ناجح ومسجل في هذه المحادثة. فعّل التتبع، وأكمل المهمة، ثم احفظها.",
  ...
  "st.sync.title": "مزامنة السحابة المشفرة",
  "st.sync.lede_html": "<strong>أعضاء WebBrain Cloud فقط.</strong> مزامنة الذكريات والملء التلقائي للملف الشخصي وإعدادات موفر مفتاح واجهة برمجة التطبيقات عبر الأجهزة. يتم تشفير كل شيء باستخدام كلمة مرور المزامنة الخاصة بك قبل التحميل. لا يستطيع WebBrain قراءته أو استعادته. لا تتم مزامنة سجل الدردشة وتسجيلات الدخول عبر OAuth.",
  "st.sync.email.label": "البريد الإلكتروني السحابي WebBrain",
  "st.sync.password.label": "مزامنة كلمة المرور للتشفير (+12 حرفًا)",
  "st.sync.confirm.label": "تأكيد كلمة مرور المزامنة",
  "st.sync.action.auth": "إرسال رابط تسجيل الدخول",
  "st.sync.action.enable": "قم بتشغيل المزامنة المشفرة",
  "st.sync.action.unlock": "فتح المزامنة المشفرة",
  "st.sync.action.now": "مزامنة الآن",
  "st.sync.action.lock": "قفل",
  "st.sync.action.change_password": "تغيير كلمة مرور المزامنة",
  "st.sync.action.disable": "قم بإيقاف تشغيل المزامنة على هذا الجهاز",
  "st.sync.action.reset": "استبدل النسخة السحابية بهذا الجهاز",
  "st.sync.status.syncing": "جارٍ تحديث المزامنة المشفرة…",
  "st.sync.status.offline": "المزامنة المشفرة في انتظار الاتصال.",
  "st.sync.status.subscription": "عضوية WebBrain Cloud مطلوبة للمزامنة المشفرة.",
  "st.sync.status.error": "المزامنة المشفرة تحتاج إلى الاهتمام.",
  "st.sync.status.auth_required": "قم بتسجيل الدخول باستخدام البريد الإلكتروني WebBrain Cloud الخاص بك لاستخدام المزامنة المشفرة.",
  "st.sync.status.password_required": "تم تسجيل الدخول. اختر كلمة مرور المزامنة لتشغيل المزامنة المشفرة.",
  "st.sync.status.unlocked": "المزامنة المشفرة قيد التشغيل لهذا الجهاز.",
  "st.sync.status.locked": "المزامنة المشفرة مقفلة. أدخل كلمة مرور المزامنة لإلغاء قفلها على هذا الجهاز.",
  "st.sync.result.updated": "تم تحديث المزامنة المشفرة.",
  "st.sync.result.current": "المزامنة المشفرة محدثة.",
  "st.sync.pending.syncing": "جارٍ مزامنة النسخة السحابية المشفرة…",
  "st.sync.pending.syncing_short": "جارٍ المزامنة…",
  "st.sync.error.generic": "فشلت المزامنة المشفرة: {error}",
  "st.sync.error.unknown": "خطأ غير معروف",
  "st.sync.validation.email_required": "أدخل البريد الإلكتروني الخاص بفواتير WebBrain Cloud.",
  "st.sync.validation.password_length": "استخدم كلمة مرور مزامنة مكونة من 12 حرفًا على الأقل.",
  "st.sync.validation.confirm_required": "قم بتأكيد كلمة مرور المزامنة.",
  "st.sync.validation.password_mismatch": "كلمات مرور المزامنة غير متطابقة.",
  "st.sync.prompt.new_password": "كلمة مرور المزامنة الجديدة",
  "st.sync.prompt.password": "{label} (+12 حرفًا):",
  "st.sync.prompt.confirm_password": "تأكيد كلمة مرور المزامنة:",
  "st.sync.prompt.current_password": "كلمة مرور المزامنة الحالية:",
  "st.sync.prompt.replacement_password": "مزامنة كلمة المرور للنسخة السحابية البديلة",
  "st.sync.auth.check_email": "تحقق من بريدك الإلكتروني، ووافق على رابط تسجيل الدخول إلى WebBrain Cloud، ثم ارجع إلى هنا.",
  "st.sync.auth.success": "تمت مصادقة المزامنة السحابية. قم بتعيين كلمة مرور وتمكين المزامنة.",
  "st.sync.confirm.disable": "هل تريد إيقاف المزامنة المشفرة على هذا الجهاز؟ ستبقى البيانات المحلية.",
